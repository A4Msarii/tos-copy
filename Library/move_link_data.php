...
<body>
    ...
    text-decoration-style: double;" value="<?php echo $pageName; ?>"><?php echo $pageName; ?></h1>
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        $briefCaseId = $connect->query("SELECT briefId FROM (
                                            ...
                                            WHERE folderId = '$f_id' AND userId = '$userId'
                                        ) AS uniqueBriefIds");
    ...
    <script>
        ...
        $("#copyNewPage").on("click", function() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "<?php echo BASE_URL; ?>Library/move_linkData.php",
                data: {
                    breifCase: breifCase,
                    pageId: pageId,
                    pageName: pageName,
