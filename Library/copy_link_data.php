                    ...
                    <div class="col-lg-12 mb-3 mb-lg-5" style="margin-right: 55px;">
                        ...
                        <div class="card card-hover-shadow h-100" style="border:1px solid black;">
                            <div class="card-header card-header-content-between" style="border-bottom: 2px solid lightgray;">
                                <h1 style="margin:10px;">Copy Link</h1>
                            </div>
                            <!-- Body -->
                            <div class="card-body justify-content-center">
                                <form>
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <h1 id="pageName" style="color: blueviolet;
    font-size: x-large;
   
    text-decoration-line: underline;
    text-decoration-style: double;" value="<?php echo $pageName; ?>" name="<?php echo $pageShop; ?>"><?php echo $pageName; ?></h1>
                                        <hr>
                                    </div>
                                    <div class="row justify-content-center">
                                        <?php
...
<script>
    ...
    $("#copyNewPage").on("click", function() {
        ...
        $.ajax({
            ...
            type: "POST",
            url: "<?php echo BASE_URL; ?>Library/copy_linkData.php",
            data: {
                breifCase: breifCase,
                pageId: pageId,
                pageName: pageName,
