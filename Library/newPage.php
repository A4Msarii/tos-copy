...
<?php include 'lb_loader.php';?>
  <div id="header-hide"> 
  <?php include('./secondWindowHeader.php'); ?></div>
          ...
          <div class="card card-hover-shadow" style="border:1px solid black; height:900px;">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo BASE_URL; ?>Library/save_editor_data.php" method="post" enctype="multipart/form-data">
                  ...
                  <div refs="page-editor@titleContainer" class="input" style="text-align:center;height: auto; width:60%;" id="pagetitlecontainer">
                    
                      <input type="hidden" value="<?php echo $_REQUEST['briefCase_ID'] ?>" name="briefId" />
                      <input type="hidden" value="<?php echo $f_id; ?>" name="folderId" />
                    <input type="text" id="name" name="pagename" placeholder="Page Title" style="color:#000000a6;" required />
                  </div><br>
                  <input type="hidden" name="briefType" value="<?php echo $_REQUEST['briefType']; ?>">
...
<!-- <script src="<?php echo BASE_URL; ?>assets/ckeditor/ckeditor.js" referrerpolicy="origin"></script> -->
