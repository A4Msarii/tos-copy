...
<head>
  <title>File/Library Management</title>
  <!-- <title>Phase</title> -->
  <meta charset="utf-8" />
...
<?php include 'lb_loader.php';?>
  ...
  <div id="header-hide">
    <?php
    include ROOT_PATH . 'includes/library_header1.php';
    ?>
  </div>
    ...
    <div>
      <div class="content container-fluid" style="height: 30rem;">
        ...
        <div class="page-header" style="padding: 0px;">
          <h1 style="color:#7901c1;">File/Library Management</h1>
          <a class="btn btn-soft-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Back To the Data Page" style="color:black; text-decoration:none;" href="<?php echo BASE_URL;?>Library/index.php"><i class="bi bi-arrow-left"></i></a>
        </div>
        <!-- End Page Header -->
      </div>
    </div>
              ...
              <ul class="nav nav-pills justify-content-center" role="tablist" style="margin-top:-20px;">
                <li class="nav-item">
                  <a class="nav-link" id="file-tab" href="#file-one" data-bs-toggle="pill" data-bs-target="#file-one" role="tab" aria-controls="file-one" aria-selected="true">
                    <div class="d-flex align-items-center" style="color:#7901c1; font-weight: bold;">
                      Files
                    </div> 
                  </a>
                </li>
  ...
  <script>
    setTimeout(function() {
      document.getElementById('info-filemanegement').style.display = 'none';
      /* or
