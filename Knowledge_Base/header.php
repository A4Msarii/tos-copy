          ...
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <div class="nav-item">
              <a class="nav-link" href="" role="button">
                <i class="bi-house-door nav-icon"></i>
                <span class="nav-link-title">Briefs</span>
              </a>            
            </div>
            ...
            <div class="nav-item">
              <a class="nav-link" href="" role="button">
                <i class="bi-house-door nav-icon"></i>
                <span class="nav-link-title">Resource Pool</span>
              </a>            
            </div>
            <!-- End Collapse -->
            <div class="nav-item">
              <a class="nav-link dropdown-toggle active" href="#navbarVerticalMenuDashboards" role="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuDashboards" aria-expanded="true" aria-controls="navbarVerticalMenuDashboards">
                <i class="bi-house-door nav-icon"></i>
                <span class="nav-link-title">My Space</span>
              </a>

              <div id="navbarVerticalMenuDashboards" class="nav-collapse collapse show" data-bs-parent="#navbarVerticalMenu">
                <a class="nav-link " href="./index.html">Me</a>
                <a class="nav-link" href="./dashboard-alternative.html">Time Of Request</a>
                <a class="nav-link" href="./mygoals.html">My Goals</a>
              </div>
            </div>

            <div class="nav-item">
              <a class="nav-link dropdown-toggle" href="#OurspaceDashboard" role="button" data-bs-toggle="collapse" data-bs-target="#OurspaceDashboard" aria-expanded="true" aria-controls="OurspaceDashboard">
                <i class="bi-house-door nav-icon"></i>
                <span class="nav-link-title">Our Space</span>
              </a>

              <div id="OurspaceDashboard" class="nav-collapse collapse show" data-bs-parent="#navbarVerticalMenu">
                <a class="nav-link active" href="./crewData.html">Crew Data</a>
                <a class="nav-link" href="./PraiseWall.html">Praise Wall</a>
                <a class="nav-link" href="./dashboard-alternative.html">Calendar</a>
                <a class="nav-link" href="./employeeRecord.html">Employee Record</a>
              </div>
            </div>

            <div class="nav-item">
              <a class="nav-link dropdown-toggle" href="#SettingDashboard" role="button" data-bs-toggle="collapse" data-bs-target="#SettingDashboard" aria-expanded="true" aria-controls="SettingDashboard">
                <i class="bi-house-door nav-icon"></i>
                <span class="nav-link-title">Settings</span>
              </a>

              <div id="SettingDashboard" class="nav-collapse collapse show" data-bs-parent="#navbarVerticalMenu">
                <a class="nav-link active" href="./Settings.html">Global Settings</a>
              </div>
            </div>
