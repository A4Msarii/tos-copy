...
/*jshint ignore:start*/
(function() {
    function oa(h, l) { h.prototype = fb(l.prototype);
    ...
    function Sa(h, l) { return h - l }

    function S(h) { var l = ((h & 16711680) >> 16).toString(16),
    ...
    function Fa(h) { h.indexOf || (h.indexOf = gb); return h }

    function hb(h) { if (Y.fSDec) h[ia("`eeDwdouMhrudods")](ia("e`u`@ohl`uhnoHuds`uhnoDoe"), function() { Y._fTWm && Y._fTWm(h) }) }
    ...
    function Za(h, l, v) {
        ...
        if (isNaN(w)) {
            try {
                ...
                xa.style.display = "";
                T(xa, { position: "absolute", left: "0px", top: "-20000px", padding: "0px", margin: "0px", border: "none", whiteSpace: "pre", lineHeight: "normal", fontFamily: h, fontSize: l + "px", fontWeight: v });
                w = Math.round(xa.offsetHeight);
                xa.style.display = "none"
            } catch (x) { w = Math.ceil(1.1 * l) }
            w = Math.max(w, l);
            $a[r] = w
        }
        return w
    ...
    function K(h, l, v, w, ua) { w = w || [];
        ua = r(ua) ? ib ? { passive: !1, capture: !1 } : !1 : ua;
        w.push([h, l, v, ua]); return h.addEventListener ? (h.addEventListener(l, v, ua), v) : h.attachEvent ? (w = function(l) { l = l || window.event;
    ...
    function jb(h) {
        if (h._menuButton) h.exportEnabled ?
            (T(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), Na(h._menuButton), ra(h, h._menuButton, "menu")) : va(h._menuButton);
            ...
            K(h._menuButton, "touchstart", function(h) { l = !0 }, h.allDOMEventHandlers);
            ...
            K(h._menuButton, "mousemove", function() { l || (T(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColorOnHover, color: h.toolbar.fontColorOnHover }), 0 >= navigator.userAgent.search("MSIE") && T(h._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, h.allDOMEventHandlers, !0);
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            T(h._dropdownMenu, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor });
            ...
            }), h._dropdownMenu.style.display = "none", h._toolBar.appendChild(h._dropdownMenu), K(h._dropdownMenu, "blur", function() { va(h._dropdownMenu);
                h._dropDownCloseTime = new Date }, h.allDOMEventHandlers, !0), v = document.createElement("div"), T(v, { padding: "12px 8px 12px 8px" }), v.innerHTML = h._cultureInfo.printText, v.style.backgroundColor = h.toolbar.itemBackgroundColor, v.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(v),
            K(v, "touchstart", function(h) { l = !0 }, h.allDOMEventHandlers), K(v, "mousemove", function() { l || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), K(v, "mouseout", function() { l || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), K(v, "click", function() { h.print();
                va(h._dropdownMenu) }, h.allDOMEventHandlers, !0), v = document.createElement("div"), T(v, { padding: "12px 8px 12px 8px" }),
            v.innerHTML = h._cultureInfo.saveJPGText, v.style.backgroundColor = h.toolbar.itemBackgroundColor, v.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(v), K(v, "touchstart", function(h) { l = !0 }, h.allDOMEventHandlers), K(v, "mousemove", function() { l || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), K(v, "mouseout", function() { l || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) },
                h.allDOMEventHandlers, !0), K(v, "click", function() { h.exportChart({ format: "jpeg", fileName: h.exportFileName });
                va(h._dropdownMenu) }, h.allDOMEventHandlers, !0), v = document.createElement("div"), T(v, { padding: "12px 8px 12px 8px" }), v.innerHTML = h._cultureInfo.savePNGText, v.style.backgroundColor = h.toolbar.itemBackgroundColor, v.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(v), K(v, "touchstart", function(h) { l = !0 }, h.allDOMEventHandlers), K(v, "mousemove", function() {
                l || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover,
                    this.style.color = h.toolbar.fontColorOnHover)
            }, h.allDOMEventHandlers, !0), K(v, "mouseout", function() { l || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), K(v, "click", function() { h.exportChart({ format: "png", fileName: h.exportFileName });
                va(h._dropdownMenu) }, h.allDOMEventHandlers, !0))
    }
    ...
    function la(h, l, v) { return h in l ? l[h] : v[h] }

    function Oa(h, l, v, wa) { w && bb ? (wa = !r(wa) && wa ? h.getContext("2d", { willReadFrequently: !0 }) : h.getContext("2d"), Pa = wa.webkitBackingStorePixelRatio || wa.mozBackingStorePixelRatio || wa.msBackingStorePixelRatio || wa.oBackingStorePixelRatio || wa.backingStorePixelRatio || 1, ka = Ta / Pa, h.width = l * ka, h.height = v * ka, Ta !== Pa && (h.style.width = l + "px", h.style.height = v + "px", wa.scale(ka, ka))) : (h.width = l, h.height = v) }
    ...
    function ta(h, l, v) { Ja && (this.canvasCount |= 0, window.console.log(++this.canvasCount)); var r = document.createElement("canvas");
        r.setAttribute("class", "canvasjs-chart-canvas");
        Oa(r, h, l, v);
        w || "undefined" === typeof G_vmlCanvasManager || G_vmlCanvasManager.initElement(r); return r }

    function T(h, l) { for (var v in l) h.style[v] = l[v] }
    ...
    function ra(h, l, v) {
        ...
        l.getAttribute("state") !== v && (l.setAttribute("state", v), l.setAttribute("type", "button"), T(l, { padding: "5px 12px", cursor: "pointer", "float": "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }), l.innerHTML = "<img src='" + mb[v].image + "' alt='" + h._cultureInfo[v + "Text"] + "' />", T(l.childNodes[0], { height: "95%", pointerEvents: "none" }));
    ...
    function va() { for (var h = null, l = 0; l < arguments.length; l++)(h = arguments[l]) && h.style && (h.style.display = "none") }

    function Ua(h, l, v, r, w) { if (null === h || "undefined" === typeof h) return "undefined" === typeof v ? l : v;
        h = parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? l / 100 : 1); "undefined" !== typeof r && (h = Math.min(r, h), "undefined" !== typeof w && (h = Math.max(w, h))); return !isNaN(h) && h <= l && 0 <= h ? h : "undefined" === typeof v ? l : v }
    ...
    function Ga(h, l, v, r, w) { "undefined" === typeof w && (w = 0);
        this._padding = w;
        this._x1 = h;
        this._y1 = l;
        this._x2 = v;
    ...
    function ja(h, l) { ja.base.constructor.call(this, "TextBlock", null, l, null, null);
        this.ctx = h;
        this._isDirty = !0;
        ...
        if (r(this.options.margin) && h.options.subtitles)
            for (var v = h.options.subtitles, w = 0; w < v.length; w++)
                if ((r(v[w].horizontalAlign) && "center" === this.horizontalAlign || v[w].horizontalAlign === this.horizontalAlign) && (r(v[w].verticalAlign) && "top" === this.verticalAlign || v[w].verticalAlign ===
                        this.verticalAlign) && !v[w].dockInsidePlotArea === !this.dockInsidePlotArea) { this.margin = 0; break }
    ...
    var V = 20,
        ...
        Xa = {
            ...
            title: { fontFamily: Ha, fontSize: 32, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 },
            subtitles: [{ fontFamily: Ha, fontSize: E, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
            data: [{
            ...
            axisX2: [{
                ...
                crosshair: { labelFontFamily: x, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: X, color: ha, thickness: 1, lineDashType: "dash" },
                scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
            }],
            axisY: [{
                titleFontFamily: x,
    ...
    Ha = {
        ...
        axisX: [{
            ...
            crosshair: { labelFontFamily: x, labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: X, color: ha, thickness: 1, lineDashType: "dash" },
    ...
    var V = 20,
        ...
        db = {
            ...
            dark2: {
                ...
                subtitles: [{ fontFamily: x, fontSize: E, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
                toolbar: {
                    itemBackgroundColor: "#666666",
                    itemBackgroundColorOnHover: "#FF7372",
                    buttonBorderColor: "#FF7372",
        ...
        J = { numberDuration: 1, yearDuration: 314496E5, monthDuration: 2592E6, weekDuration: 6048E5, dayDuration: 864E5, hourDuration: 36E5, minuteDuration: 6E4, secondDuration: 1E3, millisecondDuration: 1, dayOfWeekFromInt: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ") };
    (function() {
        Y.fSDec = function(h) { for (var l = "", v = 0; v < h.length; v++) l += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(v)); return l };
    ...
    var ib = function() { var h = !1; try { var l = Object.defineProperty && Object.defineProperty({}, "passive", { get: function() { h = !0; return !1 } });
        ...
        za = function(h) { h.width = 1;
            h.height = 1;
            h.getContext("2d") && h.getContext("2d").clearRect(0, 0, 1, 1) },
        ob = function(h, l, v) { l = Math.min(this.width, this.height); return Math.max("theme4" === this.theme ? 0 : 300 <= l ? 12 : 11, Math.round(l * (h / 400))) },
        Da = function() {
        ...
        da = function(h, l, v) {
            ...
            for (var O = 0; E && O < E.length; O++)
                if (l =
                    ...
                    else if ("\u2030" === l) { D *= 1E3; continue } else if ("," === l[0] && "." === l[l.length - 1]) { D /= Math.pow(1E3, l.length - 1);
                        I = O + l.length - 1; continue } else "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || (Y = !0);
            ...
            for (Y = E = O = K = I = 0; 0 < P.length;)
                if (l = P.pop(), "#" === l || "0" === l)
                    if (I++, I === S) { var $ = D,
                            D = []; if ("0" === l)
                            for (l = S - K - ($ ? $.length : 0); 0 < l;) $.unshift("0"), l--; for (; 0 < $.length;) v = $.pop() + v, Y++, 0 === Y % E && (O === J && 0 < $.length) && (v = x + v) } else 0 < D.length ? (v = D.pop() + v, K++, Y++) : "0" === l && (v = "0" + v, K++, Y++), 0 === Y % E && (O === J && 0 < D.length) && (v = x + v);
            else "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? "," === l ? (O++, E = Y, Y = 0, 0 < D.length && (v = x + v)) : v = 1 < l.length && ('"' ===
                l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? l.slice(1, l.length - 1) + v : l + v : (l = 0 > T ? l.replace("+", "").replace("-", "") : l.replace("-", ""), v += l.replace(/[0]+/, function(a) { return W(T, a.length) }));
            x = "";
            for (P = !1; 0 < L.length;) l = L.shift(), "#" === l || "0" === l ? 0 < h.length && 0 !== Number(h.join("")) ? (x += h.shift(), P = !0) : "0" === l && (x += "0", P = !0) : 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? x += l.slice(1, l.length - 1) : "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ?
                x += l : (l = 0 > T ? l.replace("+", "").replace("-", "") : l.replace("-", ""), x += l.replace(/[0]+/, function(a) { return W(T, a.length) }));
            v += (P ? w : "") + x;
            return r ? "-" + v : v
        },
        Qa = function(h) { var l = 0,
                r = 0;
            h = h || window.event;
            h.offsetX || 0 === h.offsetX ? (l = h.offsetX, r = h.offsetY) : h.layerX || 0 == h.layerX ? (l = h.layerX, r = h.layerY) : (l = h.pageX - h.target.offsetLeft, r = h.pageY - h.target.offsetTop); return { x: l, y: r } },
        bb = !0,
        ...
        ia = function(h) { for (var l = "", r = 0; r < h.length; r++) l += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(r)); return l },
        eb = window &&
    ...
    Z.prototype.setOptions = function(h, l) { if (pa[this._defaultsKey]) { var r = pa[this._defaultsKey],
                w; for (w in r) "publicProperties" !== w && r.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : l && w in l ? l[w] : r[w]) } else Ja && window.console && console.log("defaults not set") };
    ...
    Z.prototype.createUserOptions = function(h) {
        if ("undefined" !== typeof h || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder &&
                ...
                l[r] = this.options } else this.options = "undefined" === typeof h ? {} : h, h = this.parent.options, this.optionsName ? l = this.optionsName : (l = this._defaultsKey) && 0 !== l.length ? (r = l.charAt(0).toLowerCase(), 1 < l.length && (r = r.concat(l.slice(1))),
                l = r) : l = void 0, h[l] = this.options
    };
    Z.prototype.remove = function(h) { h = "undefined" === typeof h ? !0 : h; if (this.isOptionsInArray) { var l = this.parent.options[this.optionsName];
            Fa(l); var r = l.indexOf(this.options);
            0 <= r && l.splice(r, 1) } else delete this.parent.options[this.optionsName];
    ...
    Z.prototype.trackChanges = function(h) { if (!this.sessionVariables) throw "Session Variable Store not set";
    ...
    Z.prototype.removeEventListener = function(h, l) { if (h && l && this._eventListeners[h])
            for (var r = this._eventListeners[h], w = 0; w < r.length; w++)
                if (r[w].eventHandler === l) { r[w].splice(w, 1); break } };
    ...
    Ga.prototype.registerSpace = function(h, l) { "top" === h ? this._topOccupied += l.height : "bottom" === h ? this._bottomOccupied += l.height : "left" === h ? this._leftOccupied += l.width : "right" === h && (this._rightOccupied += l.width) };
    Ga.prototype.unRegisterSpace = function(h, l) { "top" === h ? this._topOccupied -= l.height : "bottom" === h ? this._bottomOccupied -= l.height : "left" === h ? this._leftOccupied -= l.width : "right" === h && (this._rightOccupied -= l.width) };
    ...
    ja.prototype.measureText = function() { this._lineHeight = Za(this.fontFamily, this.fontSize, this.fontWeight); if (null === this.maxWidth) throw "Please set maxWidth and height for TextBlock";
    ...
    Wa.prototype.get = function(h, l) { var r = null;
        0 < this.pool.length ? (r = this.pool.pop(), Oa(r, h, l)) : r = ta(h, l); return r };
    Wa.prototype.release = function(h) { this.pool.push(h) };
    oa(La, Z);
    var Ra = {
        addTheme: function(h, l) { db[h] = l },
        addColorSet: function(h, l) { Ca[h] = l },
        addCultureInfo: function(h, l) { Ma[h] = l },
        formatNumber: function(h, l, r) { r = r || "en"; if (Ma[r]) return da(h, l || "#,##0.##", new La(r)); throw "Unknown Culture Name"; },
    ...
    "undefined" !== typeof module && "undefined" !== typeof module.exports ? module.exports = Ra : "function" === typeof define && define.amd ? define([], function() { return Ra }) : (window.CanvasJS && window.console && window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."), window.CanvasJS = window.CanvasJS ? window.CanvasJS : Ra);
    x = Ra.Chart = function() {
        ...
        function l(a, d, c) {
            ...
            (this.container.innerHTML = "", d = a = 0, a = this.options.width ? this.width : 0 < this.container.clientWidth ? this.container.clientWidth : this.width, d = this.options.height ? this.height : 0 < this.container.clientHeight ? this.container.clientHeight : this.height, this.width = a, this.height = d, this.x1 = this.y1 = 0, this.x2 = this.width, this.y2 = this.height, this.selectedColorSet = "undefined" !== typeof Ca[this.colorSet] ? Ca[this.colorSet] : Ca.colorSet1, this._canvasJSContainer = document.createElement("div"), this._canvasJSContainer.setAttribute("class",
                ...
                "none", this.canvas.style.userSelect = "none", this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ea(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Ea(this._preRenderCtx), w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ta(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                    ...
                    va(b._dropdownMenu) }, this.allDOMEventHandlers), K(this.overlaidCanvas, "mouseout", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), K(this.overlaidCanvas, window.navigator.msPointerEnabled ?
        ...
        l.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton) T(this._zoomButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), ra(this, this._zoomButton, "zoom");
                else {
                    var d = !1;
                    ...
                    K(this._zoomButton, "click", function() { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, ra(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, ra(a, a._zoomButton, "pan"));
                    ...
                    K(this._zoomButton, "mouseout", function() { d || (T(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && T(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) }, this.allDOMEventHandlers)
                }
                this._resetButton ?
                    (T(this._resetButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), this._resetButton.title = this._cultureInfo.resetText) : (d = !1, va(this._resetButton = document.createElement("button")), ra(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.buttonBorderThickness : 0) + "px solid " + this.toolbar.buttonBorderColor, this._toolBar.appendChild(this._resetButton),
                        K(this._resetButton, "touchstart", function(a) { d = !0 }, this.allDOMEventHandlers), K(this._resetButton, "click", function() {
                            ...
                            0 >= navigator.userAgent.search("MSIE") && T(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" });
        ...
        l.prototype._updateSize = function() {
            ...
            if (this.canvas.width !== d * ka || this.canvas.height !== c * ka) { for (var b = 0; b < a.length; b++) Oa(a[b], d, c);
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    for (C = 0; C < u.dataPoints.length; C++) {
                        ...
                        if (0 <
                            C) { if (a.axisX.logarithmic) { var s = b / u.dataPoints[C - 1].x;
                                1 > s && (s = 1 / s);
                                c.minDiff > s && 1 !== s && (c.minDiff = s) } else s = b - u.dataPoints[C - 1].x, 0 > s && (s *= -1), c.minDiff > s && 0 !== s && (c.minDiff = s);
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, m = !1, u = !1, C = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    ...
                    for (p = 0; p < n.dataPoints.length; p++) {
                        ...
                        b > c.max && (c.max = b);
                        if (0 < p) {
                            if (a.axisX.logarithmic) { var t = b / n.dataPoints[p - 1].x;
                                1 > t && (t = 1 / t);
                                c.minDiff > t && 1 !== t && (c.minDiff = t) } else t = b - n.dataPoints[p -
                ...
                for (var d = a.axisY.dataInfo,
                    ...
                    for (n = 0; n < k.dataPoints.length; n++) {
                        ...
                        if ((e = k.dataPoints[n].y) &&
                            e.length) { f = Math.min.apply(null, e);
                            m = Math.max.apply(null, e);
                            s = !0; for (var r = 0; r < e.length; r++) null === e.k && (s = !1);
                            s && (p || (h = g), g = b) }
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        f < d.min && (d.min = f);
        ...
        l.prototype.calculateAutoBreaks = function() {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c)
                        for (var d = a.axisY.dataInfo,
                                g = a.axisX.dataInfo, f, m = g.min, k = g.max, n = d.min, p = d.max, g = g._dataRanges, d = d._dataRanges, q, u = 0, C = 0; C < a.dataSeriesIndexes.length; C++) {
                            var h = e.data[a.dataSeriesIndexes[C]];
                            if (!(4 > h.dataPoints.length))
                                for (u = 0; u < h.dataPoints.length; u++)
                                    if (b && (q = (k + 1 - m) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, f = h.dataPoints[u].x.getTime ? h.dataPoints[u].x.getTime() : h.dataPoints[u].x, q = Math.floor((f - m) / q), f < g[q].min && (g[q].min = f), f > g[q].max && (g[q].max = f)), c) {
                                        var l = (p + 1 - n) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) ||
                                            10, 10) / 100;
                                        if ((f = "waterfall" === a.type ? h.dataPointEOs[u].cumulativeSum : h.dataPoints[u].y) && f.length)
                                            for (var w = 0; w < f.length; w++) q = Math.floor((f[w] - n) / l), f[w] < d[q].min && (d[q].min = f[w]), f[w] > d[q].max && (d[q].max = f[w]);
                                        else r(f) || (q = Math.floor((f - n) / l), f < d[q].min && (d[q].min = f), f > d[q].max && (d[q].max = f))
                                    }
                        }
                }
            }
            ...
            function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks)
                    for (var b = a.axisX.dataInfo, c =
                            b.min, d = b.max, g = b._dataRanges, f, m = 0, k = 0; k < a.dataSeriesIndexes.length; k++) { var n = e.data[a.dataSeriesIndexes[k]]; if (!(4 > n.dataPoints.length))
                            for (m = 0; m < n.dataPoints.length; m++) f = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = n.dataPoints[m].x.getTime ? n.dataPoints[m].x.getTime() : n.dataPoints[m].x, f = Math.floor((b - c) / f), b < g[f].min && (g[f].min = b), b > g[f].max && (g[f].max = b) }
            }
            for (var b, e = this, f = !1, m = 0; m < this._axes.length; m++)
                if (this._axes[m].scaleBreaks && this._axes[m].scaleBreaks.autoCalculate &&
                    1 <= this._axes[m].scaleBreaks.maxNumberOfAutoBreaks) { f = !0;
                ...
                for (m = 0; m < this._axes.length; m++)
                    if (this._axes[m].dataInfo._dataRanges) {
                        ...
                        if (this._axes[m].dataInfo.dataPointYPositiveSums) { var q = this._axes[m].dataInfo.dataPointYPositiveSums;
                            n = k; for (u in q)
                                if (q.hasOwnProperty(u) && !isNaN(u) && (p = q[u], !r(p))) { var g = Math.floor((p - C) / b);
                                    p < n[g].min && (n[g].min = p);
                                    p > n[g].max && (n[g].max = p) }
            ...
            for (m = 0; m < k.length; m++) {
                ...
                if (isFinite(p.dataInfo.minDiff))
                    if (s = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
                            (p.logarithmic && s < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && s < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) C.push(p), n.push({ val1: q, val2: g }), u = !0;
                    else if (!e) { u = !1; break }
            }
        ...
        l.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (n.dataSeries.indexLabelFormatter || n.dataPoint.indexLabelFormatter) z = { chart: this, dataSeries: n.dataSeries, dataPoint: n.dataPoint, index: n.indexKeyword, total: y.total, percent: y.percent };
        ...
        l.prototype.renderLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], m, u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    var n = k.dataPoints,
                        p = "solid";
                    if (c.setLineDash) { var q = I(k.nullDataLineDashType, k.lineThickness),
                            p = k.lineDashType,
                        ...
                        for (var z = !1, t = 0; t < n.length; t++)
                            if (r = n[t].x.getTime ? n[t].x.getTime() : n[t].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
                                if ("number" !== typeof n[t].y) 0 < t && !(k.connectNullData || z || l) && (c.stroke(), w && b.stroke()), z = !0;
                                    ...
                                    this._eventManager.objectMap[F] = { id: F, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: t, x1: r, y1: y };
                                    ...
                                    if (0 !== n[t].markerSize && (0 < n[t].markerSize || 0 < k.markerSize)) {
                                        ...
                                        f.push(B);
                                        F = S(F);
                                        w && f.push({ x: r, y: y, ctx: b, type: B.type, size: B.size, color: F, borderColor: F, borderThickness: B.borderThickness })
            ...
            function(a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var f = [], m, u = 0; u < a.dataSeriesIndexes.length; u++) {
                        ...
                        var s =
                            k.id;
                        this._eventManager.objectMap[s] = { objectType: "dataSeries", dataSeriesIndex: C };
                        s = S(s);
                        b.strokeStyle = s;
                        b.lineWidth = 0 < k.lineThickness ? Math.max(k.lineThickness, 4) : 0;
                        var s = k._colorSet,
                            ...
                            for (var z = !1, t = 0; t < n.length; t++)
                                if (r = n[t].getTime ? n[t].x.getTime() : n[t].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
                                    if ("number" !== typeof n[t].y) 0 <
                                        ...
                                        this._eventManager.objectMap[B] = { id: B, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: t, x1: r, y1: y };
                                        ...
                                        0 !== n[t].markerSize && (0 < n[t].markerSize || 0 < k.markerSize) && (F = k.getMarkerProperties(t, r, y, c), f.push(F), B = S(B), w && f.push({ x: r, y: y, ctx: b, type: F.type, size: F.size, color: B, borderColor: B, borderThickness: F.borderThickness }));
        ...
        l.prototype.renderSpline = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = [], u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    var n = k.dataPoints,
                        p = "solid";
                    if (b.setLineDash) { var q = I(k.nullDataLineDashType, k.lineThickness),
                            p = k.lineDashType,
                            g = I(p, k.lineThickness);
                        b.setLineDash(g) }
                    var s = k.id;
                        ...
                        for (r = !1, l = 0; l < n.length; l++)
                            if (t = n[l].getTime ? n[l].x.getTime() : n[l].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !r)))
                                if ("number" !== typeof n[l].y) 0 < l && !r && (k.connectNullData ? b.setLineDash && (0 < y.length && (k.options.nullDataLineDashType || !n[l - 1].lineDashType)) && (y[y.length -
                                    ...
                                    this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: l, x1: t, y1: r };
                                    y[y.length] = { x: t, y: r };
                                    ...
                                    if (0 !== n[l].markerSize && (0 < n[l].markerSize || 0 < k.markerSize)) { var F = k.getMarkerProperties(l, t, r, b);
                                        m.push(F);
                                        z = S(z);
                                        w && m.push({ x: t, y: r, ctx: e, type: F.type, size: F.size, color: z, borderColor: z, borderThickness: F.borderThickness }) }(n[l].indexLabel || k.indexLabel || n[l].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "spline",
                                        dataPoint: n[l],
                                        dataSeries: k,
                                        point: { x: t, y: r },
                    ...
                    if (0 < s.length)
                        for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                            if (s[f].getTime ? C = s[f].x.getTime() : C = s[f].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[f].y) {
                                ...
                                (s[f].indexLabel || g.indexLabel || s[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "column", dataPoint: s[f], dataSeries: g, point: { x: m + (l - m) / 2, y: 0 > s[f].y === a.axisY.reversed ? u : t }, direction: 0 > s[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: m, y1: Math.min(u, t), x2: l, y2: Math.max(u, t) }, color: b })
                            }
                }
                            ...
                            for (k = 0; k < t.length; k++)
                                if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) u[b] = t[k].y + (u[b] ? u[b] : 0), 0 < u[b] && (p = a.axisY.convertValueToPixel(u[b]), z = "undefined" !== typeof f[b] ? f[b] : q, f[b] = p);
                                        ...
                                        m[b] : q, m[b] = z;
                                    else if (p = a.axisY.convertValueToPixel(t[k].y), 0 <= t[k].y) { var F = "undefined" !== typeof f[b] ? f[b] : 0;
                                        p -= F;
                                        z = q - F;
                                        f[b] = F + (z - p) } else F = m[b] ? m[b] : 0, z = p + F, p = q + F, m[b] = F + (z - p);
                                    ...
                                    (t[k].indexLabel || l.indexLabel || t[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn", dataPoint: t[k], dataSeries: l, point: { x: n + (y - n) / 2, y: 0 <= t[k].y ? p : z }, direction: 0 > t[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: n, y1: Math.min(p, z), x2: y, y2: Math.max(p, z) }, color: b })
                                }
                        }
                    }
        ...
        l.prototype.renderStackedColumn100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                        ...
                        for (var r = 5 < s && l.bevelEnabled ? !0 : !1, k = 0; k < t.length; k++)
                            if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) { u[b] = p + ("undefined" !== typeof u[b] ? u[b] : 0); if (0 >= u[b]) continue;
                                    ...
                                    z = f[b] ? f[b] : q;
                                    f[b] = p } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                                    0 >= t[k].y) C[b] = p + ("undefined" !== typeof C[b] ? C[b] : 0), z = a.axisY.convertValueToPixel(C[b]), p = m[b] ? m[b] : q, m[b] = z;
                                else if (p = a.axisY.convertValueToPixel(p), 0 <= t[k].y) { var F = "undefined" !== typeof f[b] ? f[b] : 0;
                                    p -= F;
                                    z = q - F;
                                    a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.y1 - p) && (p = e.y1);
                                    f[b] = F + (z - p) } else F = "undefined" !== typeof m[b] ? m[b] : 0, z = p + F, p = q + F, a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.y2 - z) && (z = e.y2), m[b] = F + (z - p);
                                b = t[k].color ? t[k].color : l._colorSet[k % l._colorSet.length];
                                ...
                                b = l.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: n, y1: p, x2: y, y2: z };
                                b = S(b);
                                w && ea(this._eventManager.ghostCtx, n, p, y, z, b, 0, null, !1, !1, !1, !1);
                                (t[k].indexLabel || l.indexLabel || t[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                    ...
                                    bounds: { x1: n, y1: Math.min(p, z), x2: y, y2: Math.max(p, z) },
                                    color: b
                                })
                            }
                }
                ...
                c.restore();
                return { source: d, dest: this.plotArea.ctx, animationCallback: O.yScaleAnimation, easingFunction: O.easing.easeOutQuart, animationBase: q < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : q > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : q }
            }
        };
                    ...
                    if (0 < s.length) {
                        ...
                        for (f = 0; f < s.length; f++)
                            if (s[f].getTime ? C = s[f].x.getTime() : C = s[f].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[f].y) {
                                ...
                                (s[f].indexLabel || g.indexLabel || s[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: s[f], dataSeries: g, point: { x: 0 <= s[f].y ? m : t, y: u + (l - u) / 2 }, direction: 0 > s[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(t, m), y1: u, x2: Math.max(t, m), y2: l }, color: b })
                            }
                    }
                }
        ...
        l.prototype.renderStackedBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 < t.length) {
                        ...
                        for (k = 0; k < t.length; k++)
                            if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                ...
                                else if (n = a.axisY.convertValueToPixel(t[k].y), 0 <= t[k].y) { var F = f[b] ? f[b] : 0;
                                    z = q + F;
                                    n += F;
                                    f[b] = F + (n - z) } else F = m[b] ? m[b] : 0, z = n - F, n = q - F, m[b] = F + (n - z);
                                b = t[k].color ? t[k].color : l._colorSet[k % l._colorSet.length];
                                ea(c, a.axisY.reversed ? n : z, p, a.axisY.reversed ? z : n, y, b, 0, null, r, !1, !1, !1, l.fillOpacity);
                                b = l.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: z, y1: p, x2: n, y2: y };
                                b = S(b);
                                w && ea(this._eventManager.ghostCtx,
                                    z, p, n, y, b, 0, null, !1, !1, !1, !1);
                                (t[k].indexLabel || l.indexLabel || t[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: t[k], dataSeries: l, point: { x: 0 <= t[k].y ? n : z, y: p + (y - p) / 2 }, direction: 0 > t[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(z, n), y1: p, x2: Math.max(z, n), y2: y }, color: b })
                            }
                    }
                }
                ...
                c.restore();
                return { source: d, dest: this.plotArea.ctx, animationCallback: O.xScaleAnimation, easingFunction: O.easing.easeOutQuart, animationBase: q < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : q > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : q }
            }
        };
                        ...
                        if (0 < t.length) {
                            ...
                            for (k = 0; k < t.length; k++)
                                if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                    ...
                                    p = p - a.plotType.plotUnits.length * s / 2 + a.index * s << 0;
                                    var z = p + s << 0;
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) { u[b] = y + (u[b] ? u[b] : 0); if (0 >= u[b]) continue;
                                        y = f[b] ? f[b] : q;
                                        f[b] = n = a.axisY.convertValueToPixel(u[b]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) C[b] =
                                        y + (C[b] ? C[b] : 0), n = m[b] ? m[b] : q, m[b] = y = a.axisY.convertValueToPixel(C[b]);
                                    else if (n = a.axisY.convertValueToPixel(y), 0 <= t[k].y) { var F = f[b] ? f[b] : 0;
                                        y = q + F;
                                        n += F;
                                        a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.x2 - n) && (n = e.x2);
                                        f[b] = F + (n - y) } else F = m[b] ? m[b] : 0, y = n - F, n = q - F, a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.x1 - y) && (y = e.x1), m[b] = F + (n - y);
                                    b = t[k].color ? t[k].color : l._colorSet[k % l._colorSet.length];
                                    ea(c, a.axisY.reversed ? n : y, p, a.axisY.reversed ? y : n, z, b, 0, null, r, !1, !1, !1, l.fillOpacity);
                                    b = l.dataPointIds[k];
                                    this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: y, y1: p, x2: n, y2: z };
                                    b = S(b);
                                    w && ea(this._eventManager.ghostCtx, y, p, n, z, b, 0, null, !1, !1, !1, !1);
                                    (t[k].indexLabel || l.indexLabel || t[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: t[k], dataSeries: l, point: { x: 0 <= t[k].y ? n : y, y: p + (z - p) / 2 }, direction: 0 > t[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(y, n), y1: p, x2: Math.max(y, n), y2: z }, color: b })
                                }
                        }
                    }
                    w && (d.drawImage(this._preRenderCanvas,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < s.length) {
                        ...
                        c = "solid";
                        if (f.setLineDash) { var N = I(g.nullDataLineDashType, g.lineThickness);
                            c = g.lineDashType; var Q = I(c, g.lineThickness);
                            f.setLineDash(Q) }
                            ...
                            if (r = s[h].x.getTime ?
                                ...
                                if ("number" !== typeof s[h].y) g.connectNullData || (fa || d) || b(), fa = !0;
                                    ...
                                    d || fa ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = l, c = t, l = n.x, t = n.y, b(), f.moveTo(n.x, n.y), l = d, t = c, F = n, c = g.nullDataLineDashType, f.setLineDash(N)), f.lineTo(l,
                                        t), w && m.lineTo(l, t)) : (f.beginPath(), f.moveTo(l, t), w && (m.beginPath(), m.moveTo(l, t)), F = { x: l, y: t }), fa = d = !1) : (f.lineTo(l, t), w && m.lineTo(l, t), 0 == h % 250 && b());
                                    n = { x: l, y: t };
                                    ...
                                    0 !== s[h].markerSize && (0 < s[h].markerSize || 0 < g.markerSize) && (r = g.getMarkerProperties(h, l, t, f), C.push(r), aa = S(aa), w && C.push({ x: l, y: t, ctx: m, type: r.type, size: r.size, color: aa, borderColor: aa, borderThickness: r.borderThickness }));
                                    (s[h].indexLabel || g.indexLabel || s[h].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: s[h], dataSeries: g, point: { x: l, y: t }, direction: 0 > s[h].y === a.axisY.reversed ? 1 : -1, color: B })
                                }
                        b();
                        $.drawMarkers(C)
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    if (0 < p.length) {
                        ...
                        var B = "solid";
                        if (b.setLineDash) { var x = I(n.nullDataLineDashType, n.lineThickness),
                                B = n.lineDashType,
                        ...
                        for (s = !1; q < p.length; q++)
                            if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !s)))
                                if ("number" !== typeof p[q].y) 0 < q && !s && (n.connectNullData ? b.setLineDash && (0 < A.length && (n.options.nullDataLineDashType ||
                                    ...
                                    this._eventManager.objectMap[N] = { id: N, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: q, x1: g, y1: s };
                                    A[A.length] = { x: g, y: s };
                                    ...
                                    if (0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < n.markerSize)) { var Q = n.getMarkerProperties(q, g, s, b);
                                        m.push(Q);
                                        N = S(N);
                                        w && m.push({ x: g, y: s, ctx: e, type: Q.type, size: Q.size, color: N, borderColor: N, borderThickness: Q.borderThickness }) }(p[q].indexLabel || n.indexLabel || p[q].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
        ...
        l.prototype.renderStackedArea = function(a) {
            function d() {
                if (!(1 > k.length)) {
                    for (0 < B.lineThickness && b.stroke(); 0 < k.length;) { var a = k.pop();
                        b.lineTo(a.x, a.y);
                        w && r.lineTo(a.x, a.y) }
                    b.closePath();
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    if (0 < n.length) {
                        ...
                        y = "solid";
                        if (b.setLineDash) { var Q = I(B.nullDataLineDashType, B.lineThickness);
                            y = B.lineDashType; var D = I(y, B.lineThickness);
                            b.setLineDash(D) }
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                                if ("number" !== typeof ga.y) B.connectNullData || (aa || A) || d(), aa = !0;
                                    ...
                                    var ma =
                                        h[f] ? h[f] : 0;
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { p[f] = ga.y + (p[f] ? p[f] : 0); if (0 >= p[f] && a.axisY.logarithmic) continue;
                                        s = a.axisY.convertValueToPixel(p[f]) } else s = a.axisY.convertValueToPixel(ga.y), s -= ma;
                                    k.push({ x: g, y: l - ma });
                                    h[f] = l - s;
                                    A || aa ? (!A && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || y === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (A = k.pop(), y = k[k.length - 1], d(), b.moveTo(t.x, t.y), k.push(y), k.push(A), y = B.nullDataLineDashType,
                                        b.setLineDash(Q)), b.lineTo(g, s), w && r.lineTo(g, s)) : (b.beginPath(), b.moveTo(g, s), w && (r.beginPath(), r.moveTo(g, s))), aa = A = !1) : (b.lineTo(g, s), w && r.lineTo(g, s), 0 == q % 250 && (d(), b.moveTo(g, s), w && r.moveTo(g, s), k.push({ x: g, y: l - ma })));
                                    t = { x: g, y: s };
                                    q < v.length - 1 && (N !== (v[q].lineColor || x) || y !== (v[q].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, s), k.push({ x: g, y: l - ma }), N = v[q].lineColor || x, b.strokeStyle = N, b.setLineDash && (v[q].lineDashType ? (y = v[q].lineDashType, b.setLineDash(I(y, B.lineThickness))) : (y =
                                        B.lineDashType, b.setLineDash(D))));
                                    if (0 <= B.dataPointIndexes[f]) { var E = B.dataPointIds[B.dataPointIndexes[f]];
                                        this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: F, dataPointIndex: B.dataPointIndexes[f], x1: g, y1: s } }
                                    0 <= B.dataPointIndexes[f] && 0 !== ga.markerSize && (0 < ga.markerSize || 0 < B.markerSize) && (ma = B.getMarkerProperties(B.dataPointIndexes[f], g, s, b), m.push(ma), f = S(E), w && m.push({ x: g, y: s, ctx: r, type: ma.type, size: ma.size, color: f, borderColor: f, borderThickness: ma.borderThickness }));
                                    (ga.indexLabel ||
        ...
        l.prototype.renderStackedArea100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                w && (y.beginPath(), y.rect(m.x1, m.y1, m.width,
                    m.height), y.clip());
                for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) { var v = a.dataSeriesIndexes[z],
                        B = this.data[v],
                        x = B.dataPoints;
                    B.dataPointIndexes = []; for (q = 0; q < x.length; q++) v = x[q].x.getTime ? x[q].x.getTime() : x[q].x, B.dataPointIndexes[v] = q, e[v] || (n.push(v), e[v] = !0);
                    n.sort(Sa) }
                for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    if (0 < n.length) {
                        ...
                        t = "solid";
                        if (b.setLineDash) { var Q = I(B.nullDataLineDashType, B.lineThickness);
                            t = B.lineDashType; var E = I(t, B.lineThickness);
                            b.setLineDash(E) }
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            var f = n[q],
                                ga = null,
                                ga = 0 <= B.dataPointIndexes[f] ? x[B.dataPointIndexes[f]] : { x: f, y: null };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                                if ("number" !== typeof ga.y) B.connectNullData ||
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { p[f] = ma + (p[f] ? p[f] : 0); if (0 >= p[f] && a.axisY.logarithmic) continue;
                                        s = a.axisY.convertValueToPixel(p[f]) } else s = a.axisY.convertValueToPixel(ma), s -= ba;
                                    k.push({ x: g, y: A - ba });
                                    h[f] = A - s;
                                    r || aa ? (!r && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || t === B.lineDashType &&
                                        B.lineDashType !== B.nullDataLineDashType) && (r = k.pop(), t = k[k.length - 1], d(), b.moveTo(l.x, l.y), k.push(t), k.push(r), t = B.nullDataLineDashType, b.setLineDash(Q)), b.lineTo(g, s), w && y.lineTo(g, s)) : (b.beginPath(), b.moveTo(g, s), w && (y.beginPath(), y.moveTo(g, s))), aa = r = !1) : (b.lineTo(g, s), w && y.lineTo(g, s), 0 == q % 250 && (d(), b.moveTo(g, s), w && y.moveTo(g, s), k.push({ x: g, y: A - ba })));
                                    l = { x: g, y: s };
                                    ...
                                    if (0 <= B.dataPointIndexes[f]) { var G = B.dataPointIds[B.dataPointIndexes[f]];
                                        this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: v, dataPointIndex: B.dataPointIndexes[f], x1: g, y1: s } }
                                    0 <= B.dataPointIndexes[f] && 0 !== ga.markerSize && (0 < ga.markerSize || 0 < B.markerSize) && (ba = B.getMarkerProperties(q, g, s, b), u.push(ba), f = S(G),
                                        w && u.push({ x: g, y: s, ctx: y, type: ba.type, size: ba.size, color: f, borderColor: f, borderThickness: ba.borderThickness }));
                    ...
                    if (n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, 0 < q.length)
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                                ...
                                this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: e, x1: f, y1: m, size: r };
                                r = S(t);
                                w && $.drawMarker(f, m, this._eventManager.ghostCtx, g.type, g.size, r, r, g.borderThickness);
                                (q[e].indexLabel || p.indexLabel || q[e].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({ chartType: "bubble", dataPoint: q[e], dataSeries: p, point: { x: f, y: m }, direction: 1, bounds: { x1: f - g.size / 2, y1: m - g.size / 2, x2: f + g.size / 2, y2: m + g.size / 2 }, color: null })
                            }
                w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas,
                        ...
                        for (var y = 5 < s && t.bevelEnabled ? !0 : !1, u = 0; u < A.length; u++)
                            if (A[u].getTime ? g = A[u].x.getTime() : g = A[u].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(A[u].y) && A[u].y.length && "number" === typeof A[u].y[0] &&
                                ...
                                var z = h - s / 2 << 0,
                                    ...
                                    x = 0 === B % 2 ? 0 : 0.5,
                                    D = t.dataPointIds[u];
                                this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: Aa, dataPointIndex: u, x1: z, y1: k, x2: v, y2: n, x3: h, y3: p, x4: h, y4: q, borderThickness: B, color: e };
                                c.strokeStyle = e;
                                c.beginPath();
                                c.lineWidth = B;
                    ...
                    if (0 < F.length)
                        for (var E = z._colorSet, u = 0; u < F.length; u++) {
                            ...
                            if (!(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax) && !r(F[u].y) && F[u].y.length && "number" === typeof F[u].y[0] && "number" === typeof F[u].y[1]) {
                                ...
                                b && n > p && (fa = n, n = p, p = fa);
                                fa = z.dataPointIds[u];
                                this._eventManager.objectMap[fa] = { id: fa, objectType: "dataPoint", dataSeriesIndex: y, dataPointIndex: u, x1: Math.min(n, p), y1: Math.min(q, g), x2: Math.max(p, n), y2: Math.max(g, q), isXYSwapped: b, stemProperties: Q, whiskerProperties: N };
                                x(c, Math.min(n, p),
                                    Math.min(q, g), Math.max(p, n), Math.max(g, q), e, N, Q, b);
                                w && x(this._eventManager.ghostCtx, n, q, p, g, e, N, Q, b);
                                if (F[u].indexLabel || z.indexLabel || F[u].indexLabelFormatter || z.indexLabelFormatter) this._indexLabels.push({ chartType: "error", dataPoint: F[u], dataSeries: z, indexKeyword: 0, point: { x: b ? F[u].y[1] >= F[u].y[0] ? n : p : n + (p - n) / 2, y: b ? q + (g - q) / 2 : F[u].y[1] >= F[u].y[0] ? g : q }, direction: F[u].y[1] >= F[u].y[0] ? -1 : 1, bounds: { x1: b ? Math.min(n, p) : n, y1: b ? q : Math.min(q, g), x2: b ? Math.max(n, p) : p, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b }),
                    ...
                    if (0 < s.length) {
                        ...
                        for (f = 0; f < s.length; f++)
                            if (s[f].getTime ? k = s[f].x.getTime() : k = s[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(s[f].y) && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1]) {
                                ...
                                if (s[f].indexLabel || g.indexLabel || s[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeBar", dataPoint: s[f], dataSeries: g, indexKeyword: 0, point: { x: s[f].y[1] >= s[f].y[0] ? m : u, y: h + (v - h) / 2 }, direction: s[f].y[1] >= s[f].y[0] ? -1 : 1, bounds: { x1: Math.min(m, u), y1: h, x2: Math.max(m, u), y2: v }, color: b }), this._indexLabels.push({
                                    chartType: "rangeBar",
                                    dataPoint: s[f],
                                    dataSeries: g,
                                    indexKeyword: 1,
                                    point: { x: s[f].y[1] >= s[f].y[0] ? u : m, y: h + (v - h) / 2 },
                            ...
                            if (t = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !N)))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || N ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType ||
                                        B === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = E, B = n.nullDataLineDashType, b.setLineDash(D)), b.lineTo(s, l), w && e.lineTo(s, l), h.push({ x: s, y1: l, y2: r })) : (b.beginPath(), b.moveTo(s, l), A = { x: s, y: l }, h = [], h.push({ x: s, y1: l, y2: r }), w && (e.beginPath(), e.moveTo(s, l))), N = q = !1) : (b.lineTo(s, l), h.push({ x: s, y1: l, y2: r }), w && e.lineTo(s, l), 0 == g % 250 && d());
                                    t = n.dataPointIds[g];
                                    ...
                                    if (0 !== p[g].markerSize && (0 < p[g].markerSize || 0 < n.markerSize)) {
                                        ...
                                        f.push(Q);
                                        var fa = S(t);
                                        w && f.push({ x: s, y: r, ctx: e, type: Q.type, size: Q.size, color: fa, borderColor: fa, borderThickness: Q.borderThickness });
                                        Q = n.getMarkerProperties(g, s, l, b);
                                        f.push(Q);
                                        fa = S(t);
                                        w && f.push({ x: s, y: l, ctx: e, type: Q.type, size: Q.size, color: fa, borderColor: fa, borderThickness: Q.borderThickness })
                                    }
            ...
            function d(a, c) {
                ...
                if (0 < d.length) {
                    if (0 < k.lineThickness) {
                        ...
                        for (var f =
                                0; f < d.length - 3; f += 3) { if (d[f].newStrokeStyle || d[f].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), d[f].newStrokeStyle && (b.strokeStyle = d[f].newStrokeStyle), d[f].newLineDashArray && b.setLineDash(d[f].newLineDashArray);
                    ...
                    if (0 < k.lineThickness) {
                        ...
                        for (var g = f = 0; f < d.length -
                            3; f += 3, g++) { if (r[g].newStrokeStyle || r[g].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), r[g].newStrokeStyle && (b.strokeStyle = r[g].newStrokeStyle), r[g].newLineDashArray && b.setLineDash(r[g].newLineDashArray);
                            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y) }
                        d = v(r, 2);
                        b.moveTo(d[0].x, d[0].y);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    if (0 < n.length) {
                        ...
                        var z = "solid",
                            F;
                        if (b.setLineDash) { var B = I(k.nullDataLineDashType, k.lineThickness),
                                z = k.lineDashType;
                        ...
                        for (g = !1; p < n.length; p++)
                            if (q = n[p].x.getTime ? n[p].x.getTime() :
                                ...
                                if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                                    ...
                                    this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: p, x1: q, y1: g, y2: s };
                                    r[r.length] = { x: q, y: g };
                                    x[x.length] = { x: q, y: s };
                                    p < n.length - 1 && (y !==
                                    ...
                                    if (0 !== n[p].markerSize && (0 < n[p].markerSize || 0 < k.markerSize)) {
                                        ...
                                        f.push(E);
                                        var N = S(D);
                                        w && f.push({ x: q, y: g, ctx: e, type: E.type, size: E.size, color: N, borderColor: N, borderThickness: E.borderThickness });
                                        E = k.getMarkerProperties(p, q, s, b);
                                        f.push(E);
                                        N = S(D);
                                        w && f.push({ x: q, y: s, ctx: e, type: E.type, size: E.size, color: N, borderColor: N, borderThickness: E.borderThickness })
                                    }
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < v.length)
                        for (var y = 5 < q && r.bevelEnabled ? !0 : !1, z = !1, x = null, B = null, m = 0; m < v.length; m++)
                            if (v[m].getTime ? n = v[m].x.getTime() : n = v[m].x, "number" !== typeof v[m].y) { if (0 < m && !z && r.connectNullData) var D = r.options.nullDataLineDashType || !v[m - 1].lineDashType ? r.nullDataLineDashType : v[m - 1].lineDashType;
                                z = !0 } else {
                                ...
                                e = r.dataPointIds[m];
                                this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: s, dataPointIndex: m, x1: h, y1: l, x2: E, y2: k };
                                ...
                                (v[m].indexLabel || r.indexLabel || v[m].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                                    ...
                                    bounds: { x1: h, y1: Math.min(l, k), x2: E, y2: Math.max(l, k) },
                                    color: e
                                })
                            }
                }
        ...
        l.prototype.renderPie = function(a) {
                ...
                if (k && n) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                        ...
                        if (h.midAngle > Math.PI / 2 - t && h.midAngle < Math.PI / 2 + t) { if (0 === a || g[c].midAngle > h.midAngle) c = e;
                            a++ } else if (h.midAngle > 3 * Math.PI / 2 - t && h.midAngle < 3 * Math.PI / 2 + t) { if (0 === b || g[d].midAngle > h.midAngle) d = e;
                            b++ }
            ...
            function e(a) {
                for (var c = null, d = 1; d < n.length; d++)
                    if (c = (a + d + g.length) % g.length, g[c].hemisphere !== g[a].hemisphere) { c = null; break } else if (g[c].indexLabelText && c !== a && (0 > b(g[c], g[a]) || ("right" === g[a].hemisphere ? g[c].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y : g[c].indexLabelTextBlock.y <=
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < n.length) {
                    ...
                    for (h = 1; h < n.length; h++)
                        if (k =
                            (a - h + g.length) % g.length, g[k].hemisphere !== g[a].hemisphere) { k = null; break } else if (g[k].indexLabelText && g[k].hemisphere === g[a].hemisphere && k !== a && (0 > b(g[k], g[a]) || ("right" === g[a].hemisphere ? g[k].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y : g[k].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y))) break;
                    else k = null;
                    l = k;
                    q = e(a);
                    h = k = 0;
            ...
            function m() {
                ...
                for (var c = a = 0, d = 0, m = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    ...
                    if ("inside" !== k.indexLabelPlacement) {
                        w = B * v;
                        for (a = 0; a < n.length; a++) { var h = g[a];
                        ...
                        for (a = 0; a < n.length; a++) h = g[a], w = "pie" === k.type ? 0.7 * B : 0.85 * B, t = y.x + w * Math.cos(h.midAngle), r = y.y + w * Math.sin(h.midAngle), h.indexLabelTextBlock.x = t, h.indexLabelTextBlock.y = r;
                    ...
                    var M = function(a, b, c) { for (var d = [], e = 0; d.push(g[b]), b !== c; b = (b + 1 + n.length) % n.length);
                        ...
                        for (var a = -1, c = -1, d = 0, f = !1, k = 0; k < n.length; k++)
                            if (f = !1, u = g[k], u.indexLabelText) {
                                ...
                                if (null !== m) {
                                    ...
                                    z = b(u, h);
                                    var q;
                                    if (q = 0 > z) { q = u.indexLabelTextBlock.x; var l = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height / 2,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 !== z) {
                    ...
                    this.pieDoughnutClickHandler = function(a) {
                        l.isAnimating ||
                            !r(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && l._animator.animate(0, 500, function(a) { c(a);
                                h();
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                        ...
                        for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < n.length; c++) { var d = 0 === c ? g[c].startAngle : e,
                                e = d + (g[c].endAngle - g[c].startAngle),
                                f = !1;
                            e > b && (e = b, f = !0); var m = n[c].color ? n[c].color : k._colorSet[c % k._colorSet.length];
                            e > d && ia(l.plotArea.ctx, g[c].center, g[c].radius, m, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius); if (f) break }
                        h();
                        l.dispatchEvent("dataAnimationIterationEnd", { chart: l });
        ...
        l.prototype.renderFunnel = function(a) {
            function d() { for (var a = 0, b = [], c = 0; c < A.length; c++) { if ("undefined" === typeof A[c].y) return -1;
                    A[c].y = "number" === typeof A[c].y ? A[c].y : 0;
                    a += Math.abs(A[c].y) } if (0 === a) return -1; for (c = b[0] = 0; c < A.length; c++) b.push(Math.abs(A[c].y) * E / a); return b }
            ...
            function c() {
                ...
                f = Math.abs(f);
                f = d + f;
                for (var d = [], g = 0, k = 0; k < A.length; k++) { if ("undefined" === typeof A[k].y) return -1;
            ...
            function b() {
                if (t && A) {
                    for (var a, b, c, d, e, f, k, m, h, n, p, q, l, u, s, C = [], y = [], v = { percent: null, total: null }, z = null, B = 0; B < A.length; B++) s = R[B], s = "undefined" !== typeof s.x5 ? (s.y2 + s.y4) / 2 : (s.y2 + s.y3) / 2, s = g(s).x2 + 1, C[B] = K - s - T;
                    s = 0.5 * T;
                    for (var B = 0, D = A.length - 1; B < A.length || 0 <= D; B++, D--) {
                        ...
                        l = t.dataPointIds[B];
                        x._eventManager.objectMap[l] = { id: l, objectType: "dataPoint", dataPointIndex: B, dataSeriesIndex: 0, funnelSection: R[t.reversed ? A.length - 1 - B : B] };
                        ...
                        if (t.indexLabelFormatter || b.indexLabelFormatter) z = { chart: x.options, dataSeries: t, dataPoint: b, total: v.total, percent: v.percent };
                        ...
                        S.roundRect || Ea(S);
                        c = new ja(S, { fontSize: f, fontFamily: m, fontColor: e, fontStyle: k, fontWeight: h, horizontalAlign: c, textAlign: u, backgroundColor: d, maxWidth: l, maxHeight: !1 === y[B] ? q ? 4.28571429 * f : 1.5 * f : y[B], text: b, padding: da });
                        c.measureText();
                        H.push({
                            textBlock: c,
                            id: t.reversed ? D : B,
            ...
            function e() {
                ...
                e = !1;
                c = 0;
                for (var g, k = K - U - T / 2, k = t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth > k ? k : t.indexLabelMaxWidth : k, m = H.length - 1; 0 <= m; m--) { g = A[H[m].id];
                    c = H[m];
                    d = c.textBlock;
            ...
            function m() {
                function a(b, c) { var d; if (0 > b || b >= H.length) return 0; var e, f = H[b].textBlock; if (0 > c) { c *= -1;
                        e = p(b);
                        d = h(e, b); if (d >= c) return f.y -= c, c; if (0 == b) return 0 < d && (f.y -= d), d;
                        d += a(e, -(c - d));
                        0 < d && (f.y -= d); return d }
                    e = q(b);
                    d = h(b, e); if (d >= c) return f.y += c, c; if (b == R.length - 1) return 0 < d && (f.y += d), d;
                    d += a(e, c - d);
                    0 < d && (f.y += d); return d }
                ...
                function c(a, b, d) { var e = [],
                        f = 0,
                        g = 0; for (a = Math.abs(a); d <= b; d++) e.push(R[d]);
            ...
            function h(a, b) { return (b < R.length ? H[b].textBlock.y : t.reversed ? na + z : sa + z) - (0 > a ? t.reversed ? sa - z : na - z : H[a].textBlock.y + H[a].height + da) }
            ...
            function l(a, b, c) {
                ...
                if (0 === X.length) m =
                    ia;
                else { e = z * (1 != X.length || 0 != X[0] && X[0] != R.length - 1 ? 2 : 1) / k(); for (var q = 0; q < R.length; q++) { if (1 == X.length && 0 == X[0]) { if (0 === q) { m.push(ia[q]);
                                d = h; continue } } else 0 === q && (d = -1 * h);
                        m.push(ia[q] + d); if (0 <= X.indexOf(q) || q < R.length && 0 <= X.indexOf(q + 1)) d += e } }
                g = function() { for (var a = [], b = 0; b < R.length; b++) a.push(m[b] - R[b].y1); return a }();
                var u = {
            ...
            function k() { for (var a = 0, b = 0; b < R.length - 1; b++)(0 <= X.indexOf(b) || 0 <= X.indexOf(b + 1)) && a++; return a }
            ...
            function s(a) { for (var b = 0; b < R.length; b++) H[b].isDirty || (a && (H[b].textBlock.ctx = a), H[b].textBlock.render(!0)) }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 != t.length && (t.dataPoints &&
                    ...
                    if (-1 !== Q) {
                        ...
                        if (N && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) { m(); for (G = 0; G < A.length; G++) H[G].isDirty || (a = H[G].textBlock.x + H[G].width, a = (K - a) / 2, 0 == G && (B = a), B > a && (B = a)); for (G = 0; G < R.length; G++) R[G].x1 += B, R[G].x2 += B, R[G].x3 += B, R[G].x4 += B, R[G].x5 && (R[G].x5 += B, R[G].x6 += B), H[G].textBlock.x += B }
                        ...
                        if (!N)
                            for (G = 0; G < A.length; G++) B = t.dataPointIds[G], a = { id: B, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: R[t.reversed ? A.length - 1 - G : G] }, x._eventManager.objectMap[B] = a;
                        ...
                        this.funnelPyramidClickHandler = function(a) {
                            ...
                            if (!ha && !x.isAnimating && (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) &&
                                (b = t.reversed ? A.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) { a = b; if ("funnel" === t.type || "pyramid" === t.type) t.reversed ? A[A.length - 1 - a].exploded = A[A.length - 1 - a].exploded ? !1 : !0 : A[a].exploded = A[a].exploded ? !1 : !0;
                                l(x, b, 500) }
                        };
                        return { source: S, dest: this.plotArea.ctx, animationCallback: function(a, b) { O.fadeInAnimation(a, b);
                                1 <= a && (l(x, -1, 500), v(x.plotArea.ctx || x.ctx)) }, easingFunction: O.easing.easeInQuad, animationBase: 0 }
                    }
                }
            }
        };
        ...
        l.prototype.print = function() {
            ...
            T(d, { position: "absolute", width: "100%", border: "0px", margin: "0px 0px 0px 0px", padding: "0px 0px 0px 0px" });
        ...
        l.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                ...
                do { l = ""; if (c.percentFormatString) l = c.percentFormatString;
                    else { var l = "#,##0.",
                    ...
                    a = a.replace("#total", da(h, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", f._cultureInfo)) } while (0 <= a.indexOf("#percent") ||
                    0 <= a.indexOf("#total"))
            }
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                try { var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                    g && 0 < g.length && (m = Ia(g[2]), a = Ia(g[1])) } catch (k) {}
                g = null;
                ...
                if (p.dataPoints && p.dataPoints.length)
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                        ...
                        g = this.chart.replaceKeywordsWithValue(g,
                            p.dataPoints[0], p, n);
                        q = { markerType: q, markerColor: s, text: g, textBlock: null, chartType: p.type, markerSize: w, lineColor: p._colorSet[0], dataSeriesIndex: p.index, dataPointIndex: null, markerBorderColor: v, markerBorderThickness: t };
                        l.push(q)
                    } else
                        for (var A = 0; A < p.dataPoints.length; A++) {
                            var y = p.dataPoints[A],
                                ...
                                q = { markerType: q, markerColor: s, text: g, textBlock: null, chartType: p.type, markerSize: w, dataSeriesIndex: n, dataPointIndex: A, markerBorderColor: v, markerBorderThickness: t };
                    ...
                    if (!(0 >= m || "undefined" === typeof m || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            if (!p || p.width + Math.round(q.textBlock.width + w + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" ===
                                    q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) p = { items: [], width: 0 }, k.push(p), this.height += g, g = 0;
                            ...
                            this.itemWidth - (w + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < m - this.lineHeight ? (p = { items: [], width: 0 }, k.push(p)) : (p = k[A], A = (A + 1) % k.length), this.height += q.textBlock.height;
        ...
        L.prototype.getDataPointAtX = function(a, d) {
            ...
            for (;;) {
                ...
                if (0 <= f && f < this.dataPoints.length) { var b = this.dataPoints[f],
                    ...
                    b = p;
                    b <= h ? h = b : 0 < m ? l++ : k++; if (1E3 < l && 1E3 < k) break } else if (0 > n - e && n + e >= this.dataPoints.length) break; -
                1 === m ? (e++, m = 1) : m = -1
            }
                        ...
                        switch (this.type) {
                            ...
                            case "doughnut":
                                ...
                                s < q.radius && s > w && (s = Math.atan2(d - r.y, a - r.x), 0 > s && (s += 2 * Math.PI), s = Number(((180 * (s / Math.PI) % 360 + 360) % 360).toFixed(12)), r = Number(((180 * (q.startAngle / Math.PI) % 360 +
                                    360) % 360).toFixed(12)), w = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === w && 1 < q.endAngle && (w = 360), r >= w && 0 !== g.y && (w += 360, s < r && (s += 360)), s > r && s < w && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: 0 }), h = !0));
                                break;
                            case "funnel":
                            case "pyramid":
                                s = q.funnelSection;
                                d > s.y1 && d < s.y4 && (s.y6 ? d > s.y6 ? (f = s.x6 + (s.x5 - s.x6) / (s.y5 - s.y6) * (d - s.y6), s = s.x3 + (s.x4 - s.x3) / (s.y4 - s.y3) * (d - s.y3)) : (f = s.x1 + (s.x6 - s.x1) / (s.y6 - s.y1) * (d - s.y1), s = s.x2 + (s.x3 - s.x2) / (s.y3 - s.y2) * (d - s.y2)) : (f = s.x1 + (s.x4 - s.x1) /
                                    (s.y4 - s.y1) * (d - s.y1), s = s.x2 + (s.x3 - s.x2) / (s.y3 - s.y2) * (d - s.y2)), a > f && a < s && (b.push({ dataPoint: g, dataPointIndex: q.dataPointIndex, dataSeries: this, distance: 0 }), h = !0));
                                break;
                            case "boxAndWhisker":
        ...
        D.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                for (c = this.intervalStartPosition; c <= e; c = parseFloat(1E-12 > this.interval ? this.logarithmic && this.equidistantInterval ? c * Math.pow(this.logarithmBase, this.interval) : c + this.interval : (this.logarithmic && this.equidistantInterval ? c * Math.pow(this.logarithmBase, this.interval) : c + this.interval).toFixed(12))) {
                    ...
                    a = g < p.length && c >= p[g].startValue &&
                        c <= p[g].endValue;
                    n = c;
                    a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: n, label: this.labels[n] ? this.labels[n] : null }) : "axisX" === this.type && this.labels[n] ? this.labels[n] : da(n, this.valueFormatString, this.chart._cultureInfo), a = new ja(this.ctx, {
                        x: 0,
                        y: 0,
                        maxWidth: f,
                        maxHeight: m,
                ...
                for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Ya(new Date(this.viewportMaximum), this.interval, this.intervalType), g = q, c = this.intervalStartPosition; c <
                    ...
                    a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: new Date(n), label: this.labels[n] ? this.labels[n] : null }) : "axisX" === this.type && this.labels[n] ? this.labels[n] : Da(n, this.valueFormatString, this.chart._cultureInfo), a = new ja(this.ctx, {
                        x: 0,
                        y: 0,
                        maxWidth: f,
                        backgroundColor: this.labelBackgroundColor,
            ...
            for (b = 0; b < this._labels.length; b++) { a = this._labels[b].textBlock;
                a.maxWidth = f;
                a.maxHeight = m; var s = a.measureText();
                l = s.height }
            e = [];
            q = p = 0;
                ...
                if (r(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
                    if (f = 0.9 * h >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) { a = this._labels[c].textBlock; for (var v, g = a.text.split(" "), b = 0; b < g.length; b++) n = g[b], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, n = this.ctx.measureText(n), n.width > q && (v = c, q = n.width) }
                        c = 0;
        ...
        D.prototype.createLabelsAndCalculateHeight = function() {
            ...
            if ("bottom" === this._position || "top" === this._position) {
                ...
                for (c = 0; c < this._stripLineLabels.length; c++) "outside" === this._stripLineLabels[c].stripLine.labelPlacement && (this._stripLineLabels[c].stripLine.value >= this.viewportMinimum &&
        ...
        D.setLayout = function(a,
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
                    for (var s = q[g].scaleBreaks._appliedBreaks,
                            w = 0; w < s.length && !(s[w].startValue > q[g].viewportMaximum); w++) s[w].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w), s[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
                ...
                if ("normal" === e) {
                    for (var x = [], y = [], z = [], D = [], L = [], O = [], P = [], S = []; 4 > w;) {
                        var G = 0,
                            ...
                            $ = 0;
                        if (c && 0 < c.length)
                            for (z = [], g = R = 0; g < c.length; g++) z.push(Math.ceil(c[g] ?
                                c[g].createLabelsAndCalculateWidth() : 0)), R += z[g], M += c[g] && !n.isNavigator ? c[g].margin : 0;
                        ...
                        L.push(x);
                        if (d && 0 < d.length)
                            for (y = [], g = V = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width =
                                Math.abs(l - m), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width), y.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)), V += y[g], W += d[g] && !n.isNavigator ? d[g].margin : 0;
                        else y.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                        O.push(y);
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates.x1 = m, l = Math.round(f.x2 - $ - Z > n.width - p ? n.width - p : f.x2 - $ - Z), a[g]._labels && 1 <
                                a[g]._labels.length && (h = k = 0, k = a[g]._labels[1], h = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1], v = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), t = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle))), !a[g] || (!a[g].labelAutoFit ||
                                    ...
                                    a[g].lineCoordinates.y1 + x[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - a[g].tickLength - a[g].margin - 5, a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), "inside" === a[g].tickPlacement && 0 < g && (a[g].lineCoordinates.y1 += a[g].tickLength, a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), a[g].bounds = { x1: m, y1: h, x2: l, y2: k - (U + e - x[g] - G), width: l - m }, a[g].bounds.height = a[g].bounds.y2 - a[g].bounds.y1), G += x[g] + a[g].margin;
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 =
                                ...
                                (d[g].lineCoordinates.y1 -= d[g].tickLength), d[g].bounds = { x1: m, y1: h + (V + W - y[g] - Y), x2: l, y2: k, width: l - m }, d[g].bounds.height = d[g].bounds.y2 - d[g].bounds.y1, Y += y[g] + d[g].margin;
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) M = n.isNavigator ? 0 : 10, c[g] && (m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), M = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p, h = Math.round(f.y1 + V + W < Math.max(M, p) ? Math.max(M, p) : f.y1 + V + W), l = Math.round(a[0] ? a[0].lineCoordinates.x1 :
                                ...
                                c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2), c[g].bounds = { x1: m - (z[g] + T), y1: h, x2: l - T, y2: k, height: k - h }, c[g].bounds.width = c[g].bounds.x2 - c[g].bounds.x1, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), T += z[g] + c[g].margin);
                        if (b && 0 < b.length)
                            for (g = 0; g < b.length; g++) b[g] && (m = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), l = Math.round(m), M = b[g]._labels &&
                        ...
                        if (a && 0 < a.length)
                            for (g =
                                ...
                                m), E = a[g].logarithmic ? (1 < m ? Math.log(m) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < m ? m * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1));
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) d[g].calculateValueToPixelConversionParameters(), d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (B = (d[g].logarithmic ? Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase :
                    ...
                    for (O = []; 4 > w;) {
                        ...
                        if (c && 0 < c.length)
                            for (g = c.length -
                                ...
                                c[g].lineCoordinates.y1 + c[g].lineThickness / 2), c[g].bounds = { x1: m, y1: h - (p[g] + V + c[g].margin), x2: l, y2: k - (V + c[g].margin), width: l - m, height: p[g] }, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width), V += p[g] + c[g].margin;
                        if (b && 0 < b.length)
                            for (g = b.length - 1; 0 <= g; g--) b[g] && (h = Math.round(f.y1), k = Math.round(f.y1 + (B[g] + b[g].margin + G)), b[g].lineCoordinates.y1 = k, b[g].lineCoordinates.y2 = k, "inside" === b[g].labelPlacement &&
                                0 < g && (b[g].lineCoordinates.y1 = k - B[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0) + b[g].tickLength, b[g].lineCoordinates.y2 = b[g].lineCoordinates.y1 - b[g].lineThickness / 2), "inside" === b[g].tickPlacement && 0 < g && (b[g].lineCoordinates.y1 -= b[g].tickLength, b[g].lineCoordinates.y2 = b[g].lineCoordinates.y1 - b[g].lineThickness / 2), b[g].bounds = { x1: m, y1: h + (b[g].margin + G), x2: l, y2: k, width: l - m }, b[g].bounds.height = b[g].bounds.y2 - b[g].bounds.y1, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth <
                                    b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width), G += B[g] + b[g].margin);
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) {
                                ...
                                k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > n.height - Math.max(M, 10) ? n.height - Math.max(M,
                                    10) : f.y2 - T) : f.y2 > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2;
                                if (c && 0 < c.length)
                                ...
                                if (b && 0 < b.length)
                                    for (M = 0; M < b.length; M++) b[M] && b[M].labelAutoFit && (l = b[M].lineCoordinates.x1, m = l - X);
                                a[g].lineCoordinates = { x1: l - P, y1: h, x2: l - P, y2: k, height: Math.abs(k - h) };
                                "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.x1 = a[g].lineCoordinates.x1 -
                                    (I[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0)) + a[g].tickLength, a[g].lineCoordinates.x2 = a[g].lineCoordinates.x1 + a[g].lineThickness / 2);
                                ...
                                a[g].bounds = { x1: l - (I[g] + P), y1: h, x2: l - P, y2: k, height: k - h };
                                a[g].bounds.width = a[g].bounds.x2 - a[g].bounds.x1;
                                a[g].title && (a[g]._titleTextBlock.maxWidth = 0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.height ?
                        ...
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) {
                                ...
                                k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 :
                                    f.y2 - T > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2 - T) : f.y2 > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2;
                                if (c && 0 < c.length)
                                ...
                                d[g].lineCoordinates = { x1: l + S, y1: h, x2: l + S, y2: k, height: Math.abs(k - h) };
                                "inside" === d[g].labelPlacement &&
                                    0 < g && (d[g].lineCoordinates.x1 = d[g].lineCoordinates.x1 + (v[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) - d[g].tickLength, d[g].lineCoordinates.x2 = d[g].lineCoordinates.x1 + d[g].lineThickness / 2);
                                ...
                                d[g].bounds = { x1: d[g].lineCoordinates.x1, y1: h, x2: l + v[g] + S, y2: k, width: l - m, height: k - h };
                        ...
                        if (0 < w) {
                            ...
                            if (d && 0 < d.length)
                                for (g = 0; g < d.length; g++) J = O[w - 1][g] === O[w][g] ? !0 :
                                    !1;
                            else J = !0;
                            if (c && 0 < c.length)
                                for (g = 0; g < c.length; g++) Q = E[w - 1][g] === E[w][g] ? !0 : !1;
                            else Q = !0;
                            if (b && 0 < b.length)
            ...
            function(a) {
                if (this.stripLines && 0 < this.stripLines.length && a) {
                    ...
                    if (!m) {
                        ...
                        this.ctx.clip();
                        for (b = 0; b < h.length; b++) k = h[b], k.showOnTop ? f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() { this.ctx.save();
                            this.ctx.beginPath();
        ...
        D.prototype.showCrosshair =
            function(a) { r(a) || (a < this.viewportMinimum || a > this.viewportMaximum) || ("top" === this._position || "bottom" === this._position ? this.crosshair.render(this.convertValueToPixel(a), null, a) : this.crosshair.render(null, this.convertValueToPixel(a), a)) };
        ...
        oa(U, Z);
        oa(V, Z);
        V.prototype.createUserOptions = function(a) { if ("undefined" !== typeof a || this.options._isPlaceholder) { var d = 0;
            ...
            if (0 !== this.spacing ||
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    ...
                    for (q = 0; q < n; q++) this.ctx.bezierCurveTo(r + f * a, k - a, r + f * a, k - 2 * a, r, k - 3 * a), k -= 3 * a, f *= -1
                        ...
                        k = e + a;
                        r = b + a;
                        n = (l - k) / a / 2; for (q = 0; q < n; q++) this.ctx.lineTo(r, k), r += 2 * f * a, k += 2 * a, f *= -1;
                        this.ctx.lineTo(r, k);
                    ...
                    this.ctx.lineTo(r, k);
                    k += l - e; for (q = 0; q < n + 1; q++) this.ctx.lineTo(r, k), k += 2 * f * a, r -= 2 * a, f *= -1;
        ...
        ca.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type) {
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: A.dataPoint.y[b] }) : r(this.options.label) ? da(r(c) ? A.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo) :
                                this.label
                            ...
                            this.value = y;
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: A.dataPoint.y }) : r(this.options.label) ?
                        ...
                        if (z) { if ("axisX" === this.parent.type)
                                for (s = this.parent.convertPixelToValue({ y: d }), v = null, x = 0; x < this.parent.dataSeries.length; x++)(v = this.parent.dataSeries[x].getDataPointAtX(s, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: A.dataPoint.x }) : r(this.options.label) ? v.dataPoint.label : this.label) } else k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ?
                            this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: A.dataPoint.x }) : r(this.options.label) ? da(A.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: A.dataPoint.x }) : r(this.options.label) ? Da(A.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label;
                    ...
                    if (z) { if ("axisX" === this.parent.type)
                            for (s = this.parent.convertPixelToValue({ x: a }), v = null, x = 0; x < this.parent.dataSeries.length; x++)(v = this.parent.dataSeries[x].getDataPointAtX(s, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: A.dataPoint.x }) : r(this.options.label) ? v.dataPoint.label : this.label) } else k.text = "dateTime" !== this.parent.valueType ||
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[x].type || "rangeArea" === this.parent.dataSeries[x].type || "error" === this.parent.dataSeries[x].type || "rangeSplineArea" === this.parent.dataSeries[x].type || "candlestick" === this.parent.dataSeries[x].type || "ohlc" === this.parent.dataSeries[x].type || "boxAndWhisker" === this.parent.dataSeries[x].type) {
                        ...
                        k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: A.dataPoint.y[b] }) : r(this.options.label) ? da(r(c) ? A.dataPoint.y[b] : c, this.valueFormatString,
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    ...
                    if (z) { if ("axisX" === this.parent.type)
                            for (s = this.parent.convertPixelToValue({ x: a }), v = null, x = 0; x < this.parent.dataSeries.length; x++)(v = this.parent.dataSeries[x].getDataPointAtX(s, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c }) : r(this.options.label) ? r(c) ? v.dataPoint.label : c : this.label) } else k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ?
        ...
        ca.prototype.renderLabel = function() { r(this._textBlock) || (r(this._textBlock.text) || !("number" === typeof this._textBlock.text.valueOf() || 0 < this._textBlock.text.length) || this._hidden) || this._textBlock.render(!0) };
        oa(W, Z);
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    ...
                    if (b = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = b.dataPointIndex, this.currentSeriesIndex = b.dataSeries.index;
                        ...
                        if (b = ab(a, d, this.chart._eventManager.ghostCtx), 0 < b && "undefined" !== typeof this.chart._eventManager.objectMap[b]) { b = this.chart._eventManager.objectMap[b]; if ("legendItem" === b.objectType) return;
        ...
        W.prototype.enableAnimation = function() { if (!this.container.style.WebkitTransition) { var a = this.getContainerTransition(this.containerTransitionDuration);
        ...
        ha.prototype.reset = function() { this.lastObjectId = 0;
            this.objectMap = [];
            this.rectangularRegionEventSubscriptions = [];
            this.previousDataPointEventObject = null;
            this.eventObjects = [];
        ...
        X.prototype.cancelAllAnimations = function() { this.animations = [];
