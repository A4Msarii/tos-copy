...
<!--Main contect We need to insert data here-->
  <main id="content" role="main" class="main">
    ...
    <!-- Content -->
    <div class="content container-fluid" style="margin-top: -22rem; text-align: center;">
      <img src="<?php echo BASE_URL;?>assets/svg/404_Error.gif" alt="Image Description" style="width: 800px; height:800px;">
