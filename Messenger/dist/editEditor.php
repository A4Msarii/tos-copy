...
<body>
  ...
  <div class="editor-container-fluid">
    ...
    <form action="<?php echo BASE_URL; ?>Messenger/dist/savePageData.php" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="mainId" value="<?php echo $_REQUEST['mainId']; ?>">
      ...
      <div class="container-fluid" style="height:50px;">
        <a style="position: fixed;margin-left:30px;" class="btn btn-soft-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" style="color:black; text-decoration:none;" href="<?php echo BASE_URL; ?>chatbox/chatmain.php?chatId=<?php echo $_REQUEST['chatId']; ?>"><i class="bi bi-arrow-left"></i></a>
