...
if (isset($_REQUEST['chatId'])) {
    ...
    $chatQ = $connect->query("SELECT * FROM groupchats WHERE groupId = '$chatId' ORDER BY date asc");
    while ($chatData = $chatQ->fetch()) {
        $chatMainId = $chatData['messages'];
        $rsId = $chatData['groupId'];
                                    ...
                                    <div class="message-content">
                                        ...
                                        <div class="message-action">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="linkRepl dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#replyMsgModal" style="cursor: pointer;font-size: large;" data-name="<?php echo $newFileData['filename']; ?>" data-id="<?php echo $chatData['id']; ?>">
                                                            <span class="me-auto">Reply</span>
                                                            <div class="icon">
                                                                <i class="bi bi-reply"></i>
                                                            </div>
                                    ...
                                    <div class="message-action">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                        <a class="dropdown-item d-flex align-items-center fetchLinkDetail" href="<?php echo BASE_URL; ?>Messenger/dist/editGroupEditor.php?chatId=<?php echo $chatId; ?>&editId=<?php echo $pageQData['id']; ?>&mainId=<?php echo $chatData['id']; ?>">
                                                            <span class="me-auto">Edit</span>
                                                            <div class="icon">
                                                                <i class="bi bi-pen"></i>
                                                            </div>
