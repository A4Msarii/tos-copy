...
<body>
    ...
    <div class="editor-container-fluid">
        ...
        <form action="<?php echo BASE_URL; ?>Messenger/dist/saveGropupPageData.php" method="post" enctype="multipart/form-data">
            <input type="hidden" name="senderId" value="<?php echo $_REQUEST['chatUser']; ?>">

            <div class="container-fluid" style="height:50px;">
                <a style="position: fixed;margin-left:30px;" class="btn btn-soft-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" style="color:black; text-decoration:none;" href="<?php echo BASE_URL; ?>chatbox/chatGroup.php?groupId=<?php echo $_REQUEST['chatUser']; ?>"><i class="bi bi-arrow-left"></i></a>
                <div class="row" style="float: right;">
                    <button name="pagesubmit" type="button" style="float:right; color:black;" class="btn nav-item" data-bs-toggle="modal" data-bs-target="#pageper"><i class="bi bi-download" style="color:black;"></i>Save Changes</button>
                </div>
