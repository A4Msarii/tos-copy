...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo BASE_URL; ?>Messenger/dist/insert_task.php" method="post" enctype="multipart/form-data">
                        <div>
                            <table class="table">
                                <div class="row">
                                    <div class="col-12">
                                        <label class="form-label text-dark" style="font-weight:bold;">Task</label>
                                        <input type="text" class="form-control checklist" name="checklist">
                                    </div>
                                    <!-- <tr>
                                    <td>
                                        <label class="form-label text-dark" style="font-weight:bold;">Task</label>
                                    ...
                                    <!-- <tr>
                                    <td>
                                        <label class="form-label text-dark" style="font-weight:bold;">Add Color</label>
                                        <input type="color" name="color" id="" class="form-control" style="height:45px;">
                                    </td>
                                    <td id="course">
                                        <label class="form-label text-dark" style="font-weight:bold;">Priority</label>
                                        <select class="form-control" name="priority" id="select_course_test">
                        ...
                        <input type="submit" value="Save" name="addTask" class="btn btn-success" style="float:right;" />
                    </form>
                </div>
        ...
        <?php if (isset($chatId)) { ?>
            $(document).ready(function() {
                ...
                function myFunction() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo BASE_URL; ?>Messenger/dist/fetchMsg.php',
                        data: {
                            chatId: chatId,
                        },
            ...
            $("#sendChatMsg").on("click", function() {
                ...
                if (chatMsg >= 0) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo BASE_URL; ?>Messenger/dist/send_msg.php',
                        data: {
                            senderId: sId,
                            msg: chatMsg
                        },
            ...
            $(document).ready(function() {
                ...
                function myFunction1() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo BASE_URL; ?>Messenger/dist/fetchTypeData.php',
                        data: {
                            chatId: chatId,
                        },
                        success: function(response) {
                            $("#typeingData").empty();
                            $("#typeingData").html(response);
                        }
                    });
                }
                ...
                // Call the function every 5 seconds
                setInterval(myFunction1, 5000); // 5000 milliseconds = 5 seconds
            });
    ...
    <script>
        $("#fileOpt").change(function() {
            ...
            if ($(this).val() == "addNewPage") {
                ...
                window.location.href = "<?php echo BASE_URL; ?>Messenger/dist/editorPage.php?chatId=" + chatUser;
            }
        });
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // Store the scroll position when the window is being unloaded (e.g., on refresh)
    ...
    <script>
        // $(".fetchTaskName").on("click",function(){
        $(document).on("click", ".fetchTaskName", function() {
            const taskName = $(this).data("taskname");
            $(".checklist").val(taskName);
        })
    </script>
