...
<body>
  ...
  <div class="editor-container-fluid">
    ...
    <form action="<?php echo BASE_URL; ?>Messenger/dist/saveGropupPageData.php" method="post" enctype="multipart/form-data">
    <input type="hidden" name="senderId" value="<?php echo $_REQUEST['chatId']; ?>">
    <input type="hidden" name="editId" value="<?php echo $_REQUEST['editId']; ?>">
    <input type="hidden" name="mainId" value="<?php echo $_REQUEST['mainId']; ?>">

      <div class="container-fluid" style="height:50px;">
        <a style="position: fixed;margin-left:30px;" class="btn btn-soft-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" style="color:black; text-decoration:none;" href="<?php echo BASE_URL; ?>chatbox/chatGroup.php?groupId=<?php echo $_REQUEST['chatId']; ?>"><i class="bi bi-arrow-left"></i></a>
        <div class="row" style="float: right;">
          <button name="editPage" type="submit" style="float:right; color:black;" class="btn nav-item"><i class="bi bi-download" style="color:black;"></i>Save Changes</button>
        </div>
      ...
      <?php
      $ch = $_REQUEST['editId'];
      $editQ = $connect->query("SELECT pageName,editorData FROM editor_data WHERE id = '$ch'");
      $editQData = $editQ->fetch();

      ?>
        
        <input type="text" id="name" value="<?php echo $editQData['pageName']; ?>" name="pagename" placeholder="Page Title" style="color:#000000a6;" required /><br><br>
        
      </div>
      <textarea id="editor" class="editor-content" style="height: 650px;" name="editorData">
      <?php echo $editQData['editorData']; ?>
    </textarea>
