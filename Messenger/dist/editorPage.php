  ...
  <div class="editor-container-fluid">
    ...
    <input type="hidden" name="senderId" value="<?php echo $_REQUEST['chatId']; ?>">
      ...
      <div class="container-fluid" style="height:50px;">
        <a style="position: fixed;margin-left:30px;" class="btn btn-soft-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" style="color:black; text-decoration:none;" href="<?php echo BASE_URL; ?>Messenger/dist/chat-direct.php?chatId=<?php echo $_REQUEST['chatId']; ?>"><i class="bi bi-arrow-left"></i></a>
