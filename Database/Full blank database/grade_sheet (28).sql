...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2024 at 12:43 PM
...
--
-- Table structure for table `coursepermission`
--

CREATE TABLE `coursepermission` (
  `id` int(11) NOT NULL,
  `courseId` varchar(255) DEFAULT NULL,
  `permissionUser` varchar(255) DEFAULT NULL,
  `userId` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `course_color`
--

CREATE TABLE `course_color` (
  `id` int(11) NOT NULL,
  `courseName` varchar(255) DEFAULT NULL,
  `color` varchar(255) DEFAULT NULL,
  `userId` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `custom_menu_names`
--

CREATE TABLE `custom_menu_names` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `enddays`
--

CREATE TABLE `enddays` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `gradeaheet_clear_reason1`
--

CREATE TABLE `gradeaheet_clear_reason1` (
  `id` int(255) NOT NULL,
  `userId` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `hideclass`
--

CREATE TABLE `hideclass` (
  `id` int(11) NOT NULL,
  `ctpId` varchar(255) DEFAULT NULL,
  `courseCode` varchar(255) DEFAULT NULL,
  `userId` varchar(255) DEFAULT NULL
...
--
-- Table structure for table `mute_notification`
--

CREATE TABLE `mute_notification` (
  `id` int(11) NOT NULL,
  `userId` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `progress_weekend`
--

CREATE TABLE `progress_weekend` (
  `id` int(11) NOT NULL,
  `weekend` varchar(255) DEFAULT NULL,
  `ctpId` varchar(255) DEFAULT NULL,
  `courseCode` varchar(255) DEFAULT NULL
...
CREATE TABLE `roles` (
  ...
  `color` varchar(255) DEFAULT NULL,
  `copiedfrom` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `role_updated_request`
--

CREATE TABLE `role_updated_request` (
  `id` int(255) NOT NULL,
  `userid` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `unclock_gradsheet_reason`
--

CREATE TABLE `unclock_gradsheet_reason` (
  `id` int(255) NOT NULL,
  `user_id` varchar(255) DEFAULT NULL,
  `reason` varchar(2000) DEFAULT NULL,
...
--
-- Table structure for table `unclock_gradsheet_reason1`
--

CREATE TABLE `unclock_gradsheet_reason1` (
  `id` int(255) NOT NULL,
  `user_id` varchar(255) DEFAULT NULL,
  `reason` varchar(2000) DEFAULT NULL,
  `g_id` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `working_file`
--

CREATE TABLE `working_file` (
  `id` int(255) NOT NULL,
  `fileId` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexes for table `coursepermission`
--
ALTER TABLE `coursepermission`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `course_color`
--
ALTER TABLE `course_color`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `custom_menu_names`
--
ALTER TABLE `custom_menu_names`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `gradeaheet_clear_reason1`
--
ALTER TABLE `gradeaheet_clear_reason1`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `hideclass`
--
ALTER TABLE `hideclass`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `mute_notification`
--
ALTER TABLE `mute_notification`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `progress_weekend`
--
ALTER TABLE `progress_weekend`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `role_updated_request`
--
ALTER TABLE `role_updated_request`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `unclock_gradsheet_reason`
--
ALTER TABLE `unclock_gradsheet_reason`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `unclock_gradsheet_reason1`
--
ALTER TABLE `unclock_gradsheet_reason1`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `working_file`
--
ALTER TABLE `working_file`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `coursepermission`
--
ALTER TABLE `coursepermission`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `course_color`
--
ALTER TABLE `course_color`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `custom_menu_names`
--
ALTER TABLE `custom_menu_names`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `enddays`
--
ALTER TABLE `enddays`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `gradeaheet_clear_reason1`
--
ALTER TABLE `gradeaheet_clear_reason1`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `hideclass`
--
ALTER TABLE `hideclass`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `mute_notification`
--
ALTER TABLE `mute_notification`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `progress_weekend`
--
ALTER TABLE `progress_weekend`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `role_updated_request`
--
ALTER TABLE `role_updated_request`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `unclock_gradsheet_reason`
--
ALTER TABLE `unclock_gradsheet_reason`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `unclock_gradsheet_reason1`
--
ALTER TABLE `unclock_gradsheet_reason1`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `working_file`
--
ALTER TABLE `working_file`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT;
COMMIT;
