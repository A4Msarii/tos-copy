...
<footer>
  <div class="container pb-1 pb-lg-7">
    <div class="row">
      <div class="col-12 col-lg-3 mb-7 mb-lg-0">
        ...
        <div class="mb-5">
          <a class="navbar-brand" href="" aria-label="Space">
            <div style="display: flex;">
              <img class="zi-2" src="<?php echo BASE_URL;?>assets/svg/logos/TOS.png" alt="Image Description" style="height:50px; width: 50px;">
        ...
        <div class="mb-5">
          <a class="navbar-brand" href="" aria-label="Space">
            <div style="display: flex;">
              <img class="zi-2" src="<?php echo BASE_URL;?>assets/svg/logos/TOS.png" alt="Image Description" style="height: 100px;
    width: 200px;">
            </div>
            <p class="text-muted small" style="text-align: right; margin-right:50px;">V2.6.0</p>
          </a>
        </div> 
        ...
        <ul class="list-unstyled list-py-1">
          <li><a class="link-sm link-secondary text-white" href="#"><i class="bi-geo-alt-fill me-1"></i> Alkarama, Abu Dhabi, UAE</a></li>
          <li><a class="link-sm link-secondary text-white" href="tel:1-062-109-9222"><i class="bi-telephone-inbound-fill me-1"></i> +1 505 886 1117</a></li>
      ...
      <div class="col-6 col-sm mb-7 mb-sm-0">
        ...
        <ul class="list-unstyled list-py-1 mb-0">
          <li><a class="link-sm link-secondary text-white" href="#">About</a></li>
          <li><a class="link-sm link-secondary text-white" href="#">Help</a>
          <li><a class="link-sm link-secondary text-white" href="#">Contact</a></li>
          <li><a class="link-sm link-secondary text-white" href="#">Tutorial</a></li>
          <li><a class="link-sm link-secondary text-white" href="login.php">Login Page</a></li>
      ...
      <div class="col-6 col-sm">
        <h5 class="mb-3 text-white">Documentation</h5>

        <!-- List -->
        <ul class="list-unstyled list-py-1 mb-0">
          <li><a class="link-sm link-secondary text-white" href="#">Support</a></li>
          <li><a class="link-sm link-secondary text-white" href="#">Docs</a></li>
          <li><a class="link-sm link-secondary text-white" href="#">Tech Requirements</a></li>
        </ul>
        <!-- End List -->
      </div>
      <!-- End Col -->
      ...
      <div class="col-6 col-sm">
        ...
        <ul class="list-unstyled list-py-1 mb-5">
          <li><a class="link-sm link-secondary text-white" href="#"><i class="bi-question-circle-fill me-1"></i> Help</a></li>
          <li><a class="link-sm link-secondary text-white" href="#"><i class="bi-person-circle me-1"></i> Your Account</a></li>
          <li><a class="link-sm link-secondary text-white" href="#"><i class="bi-person-circle me-1"></i> Knowledge Base</a></li>
        </ul>
        <!-- End List -->
      </div>
      <!-- End Col -->
      ...
      <div class="col-sm mb-3 mb-sm-0">
        ...
        <ul class="list-inline list-separator mb-0">
          <li class="list-inline-item">
            <a class="text-body text-white" href="#">Privacy & Policy</a>
          </li>
          <li class="list-inline-item">
            <a class="text-body text-white" href="#">Terms</a>
          </li>
          <li class="list-inline-item">
            <a class="text-body text-white" href="#">Site Map</a>
          </li>
        </ul>
        <!-- End Socials -->
      </div>
            ...
            <div class="btn-group">
              <button type="button" class="btn btn-soft-secondary btn-xs dropdown-toggle" id="footerLightSelectLanguage" data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation>
                <span class="d-flex align-items-center">
                  ...
                  <span class="text-white">English (US)</span>
                </span>
              </button>
          ...
          <li class="list-inline-item">
            ...
            <div class="btn-group">
              ...
              <div class="dropdown-menu" aria-labelledby="footerLightSelectLanguage">
                <a class="dropdown-item d-flex align-items-center active" href="#">
                  <img class="avatar avatar-xss avatar-circle me-2" src="<?php echo BASE_URL;?>assets/vendor/flag-icon-css/flags/1x1/us.svg" alt="Image description" width="16"/>
                  <span class="text-white">Default Mode</span>
                </a>
    ...
    <div class="w-md-85 text-lg-center mx-lg-auto">
      <p class="text-muted small text-white">© Msarii.<script>document.write(new Date().getFullYear())</script>. All rights reserved.</p>
      <p class="text-muted small text-white">Version - 2.6.0</p>
      <p class="text-muted small text-white">When you visit or interact with our sites, services or tools, we or our authorised service providers may use cookies for storing information to help provide you with a better, faster and safer experience and for marketing purposes.</p>
    </div>
