     ...
     <div>
      <div class="content container-fluid" style="height: 30rem;">
        ...
        <div class="page-header" style="padding: 0px;">
          <h1 class="text-success">Manage Phase On Testing Page</h1>
        </div>
        <!-- End Page Header -->
      </div>
    </div>
        ...
        <div class="col-lg-10 mb-3 mb-lg-5">
          ...
          <div class="card card-hover-shadow h-100" style="border:0.001rem solid #dddddd;">
            ...
            <div class="card-body">
                ...
                <form action="selected_phase_test.php" method="post" style="width:100%;" enctype="multipart/form-data">
                    ...
                    foreach($select_ctpsre2 as $select_ctpsrow2)
                      {
                        ...
                        $sql = "SELECT count(*) FROM `test_phase` WHERE phase = ?"; 
...
<hr>
              <br><br>         <table class="table table-striped table-bordered">
                    <thead class="bg-dark">
                      ...
                      <th class="text-white">Phases</th>
                      <th class="text-white" colspan="2">Action</th>
                    </thead>
                    <?php 
                    $query112 = "SELECT * FROM test_phase where ctp_id='$ctp'";
                      ...
                      <tr>
                       ...
                       <td>
                       <a href="test_phase_del.php?id=<?php echo $del_id_phase?>"><i class="bi bi-trash-fill text-danger"></i></a>
