    ...
    <div>
      <div class="content container-fluid" style="height: 30rem;">
        ...
        <div class="page-header" style="padding: 0px;display: flex;">
          <a class="btn btn-soft-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" style="color:black; text-decoration:none;" href="qual_data.php"><i class="bi bi-arrow-left"></i></a>
          <h1 class="text-success">
            <img style="height:35px; width:35px;" src="<?php echo BASE_URL; ?>assets/svg/3d_icons_green/Qual.png">
            Qual Log
          </h1>
        </div>
        <!-- End Page Header -->
            ...
            <div class="card-body">
              ...
              <table class="table table-bordered target-table table-hover" id="radio">
                ...
                <tbody id="filterDataTable">
                  ...
                  $classQ = $connect->query("SELECT className FROM classfilter WHERE pageName = 'qual'");
                  echo $classData2 = $classQ->fetchColumn();

                  $eme_id = "SELECT * FROM qual_data where ctp_id='$std_course1'";
              ...
              INNER JOIN subitem ON subitem_gradesheet.subitem_id = subitem.id where subitem.subitem='$eme_get_subid' and subitem_gradesheet.user_id='$fetchuser_id' and subitem_gradesheet.grade!=''";
                    ...
                    if ($st->rowCount() > 0) {
                      ...
                      foreach ($re as $value) {
                        ...
                        $item_ides = "";
                        if ($eme_get_id != 0) {
                          $sel_item_data = "SELECT * FROM item WHERE id='$idd'";
                  ...
                  ?>
                        <tr>
                          ...
                          <?php if (isset($_SESSION['permission']) && $permission['delete_emergance'] == "1") { ?>
                            <td><a href="delete_qual_item.php?id=<?php echo $eme_id ?>" style="font-size:small; border:1px solid #ed4c78;"><i class="bi bi-trash-fill text-danger"></i> </td>
                          <?php } ?>
                        </tr>
                      <?php }
                    } else { ?>
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="qual_submit.php" method="get">
              ...
              <tbody>
                ...
                if ($item_selst->rowCount() > 0) {
                  ...
                  foreach ($students as $student) {
                    $check_id = $student['id'];
                    $checkitem_sel = "SELECT * FROM qual_data where item='$check_id' AND user_id='$fetchuser_id'";
