<div class="frame_select" style="display:none">
<form action="insert_frame_cert.php" method="post" enctype="multipart/form-data">     
<input type="hidden" value="<?php echo $cert_id; ?>" name="cert_id">
            ...
            <label>height:</label><input type="number" required class="form-control" name="image_height" style="width:20%" placeholder="eg 10px" value="800">
            <label>width:</label><input type="number" required class="form-control" name="image_width" style="width:20%" placeholder="eg 10px" value="1300"> 
