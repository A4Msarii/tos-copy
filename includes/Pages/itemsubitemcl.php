...
<body>
  ...
  <div id="header-hide" style="display:none;">
    ...
    include("php_value_gradesheetcl.php");
    ...
    <div class="row">
            ...
            <tbody>
              ...
              ?>
                  <tr class="Myitem" style="<?php echo $bac_ground ?>; cursor: pointer;" id="color_tr<?php echo $sn112 ?>">
                    ...
                    <td style="font-weight:bold;width: 30%;"><?php $item_id = $row['item'];
                                                              //select name of item of item id
                                                              $q = $connect->prepare("SELECT item FROM `itembank` WHERE id=?");
                                                              $q->execute([$item_id]);
                                                              $name = $q->fetchColumn();
                                                              ?>
                      <span id="selectitemDropdown<?php echo $item_id ?>" data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation class="itemDetail" name="<?php echo $item_id; ?>" value="<?php echo $fetchuser_id; ?>" data-value="<?php echo $bac_ground; ?>" data-name="<?php echo $get_clone_ides; ?>" title="<?php echo $name; ?>"><?php echo substr($name, 0, 20) ?>
                    ...
                    <td>
                      <div style="display: flex;">
                        ...
                        <button data-bs-placement="right" title="Grades Info" type="button" class="badge info" id="selectinfoDropdown<?php echo $item_id; ?>" data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation><i class="bi bi-exclamation" style="font-weight: bold;"></i></button>
                  ...
                  ?>
                      <tr id="color_tr1<?php echo $sn116 . $sn112 ?>" class="subitem_tr" style="<?php echo $bac_ground1; ?>;cursor:pointer;">
                        <td style="text-align:end;"><?php echo $sn116; ?></td>
                        <td><span id="selectitemDropdown<?php echo $std_subi ?>" style="margin-left:15px;" data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation class="subItemDetail" name="<?php echo $std_subi; ?>" value="<?php echo $fetchuser_id; ?>" data-value="<?php echo $bac_ground1; ?>" data-name="<?php echo $get_clone_ides; ?>" title="<?php echo $sub_value = $name_sub; ?>"><?php echo $sub_value = substr($name_sub, 0, 20); ?></span>
                        ...
                        <td>
                          <div class="d-flex">
                            ...
                            <button data-bs-placement="right" title="Grades Info" type="button" class="badge info" id="selectinfoDropdown<?php echo $std_subi; ?>" data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation><i class="bi bi-exclamation" style="font-weight: bold;"></i></button>

                            <div class="dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="selectinfoDropdown<?php echo $std_subi; ?>">
                              <span class="dropdown-header">
                                <?php
                                $allitemdes = "SELECT * FROM sub_item where id='$std_subi'";
                            ...
                            <button data-bs-toggle="tooltip" data-bs-placement="right" title="Send" type="button" class="badge append_data1"><i class="bi bi-arrow-right-short append_data" data-appenditemid="<?php echo $sn112 . $sn116 . '. '; ?>" data-appenditemname="<?php echo $name_sub ?>" style="font-weight: bold;"></i></button>
      ...
      <div class="col-4">
            ...
            ?>
                <tr class="Myitem" style="<?php echo $bac_ground ?>; cursor:pointer;" id="color_tr<?php echo $sn112 ?>">
                  ...
                  <td style="font-weight:bold;"><?php $item_id = $row['item'];
                                                ...
                                                $name = $q->fetchColumn();
                                                ?>
                    <span id="selectitemDropdown<?php echo $item_id ?>" data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation class="itemDetail" name="<?php echo $item_id; ?>" value="<?php echo $fetchuser_id; ?>" data-value="<?php echo $bac_ground; ?>" data-name="<?php echo $get_clone_ides; ?>"><?php echo $name ?></span>
                  ...
                  <td>
                    <div style="display: flex;">
                      ...
                      <button data-bs-toggle="tooltip" data-bs-placement="right" title="Grades Info" type="button" class="badge info" id="selectinfoDropdown<?php echo $item_id; ?>" data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation><i class="bi bi-exclamation" style="font-weight: bold;"></i></button>
                ...
                ?>
                    <tr id="color_tr1<?php echo $sn116 . $sn112 ?>" class="subitem_tr" style="<?php echo $bac_ground1; ?>">
                      <td style="text-align:end;"><?php echo $sn116; ?></td>
                      <td><span id="selectitemDropdown<?php echo $std_subi ?>" style="margin-left:15px;" data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation class="subItemDetail" name="<?php echo $std_subi; ?>" value="<?php echo $fetchuser_id; ?>" data-value="<?php echo $bac_ground1; ?>" data-name="<?php echo $get_clone_ides; ?>"><?php echo $sub_value = $name_sub; ?> </span>
                        <input type="hidden" name="items_id[]" value="<?php echo $subitem_db_id ?>">
                        <input type="hidden" name="std_idies[]" value="<?php echo $item_id ?>">
                        <input type="hidden" name="std_sub[]" value="<?php echo $sub_value ?>">
                        <div class="dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="selectitemDropdown<?php echo $std_subi ?>">
        ...
        <div class="dropdown dropup m-1">
          ...
          <button type="button" class="btn btn-dark over_all_comment_add btncolor" title="Add Extra Items For This Gradesheet" id="selectLanguageDropdown" data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation>
          ...
          <div class="dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="selectLanguageDropdown" style="width:300px; height:600px; overflow-y:auto;">
            ...
            <table class="table table-bordered table-striped table-hover" id="itemsubitem">
              ...
              <thead class="bg-dark">
                <th class="text-white"><input type="checkbox" name="uuu[]" id="select-extra-itemextra"></th>
                <th class="text-white">Item</th>
              </thead>
              <tbody>
                <?php
                ...
                if ($statementallnotitem->rowCount() > 0) {
                  ...
                  foreach ($resultallnotitem as $rowallnotitem) {
                    ...
                    $sql521 = "SELECT count(*) FROM `extra_item_subitem_cl` WHERE item_id='$rowallnotitem1' AND data_type='item' and cloneid='$get_clone_ides' and class_id='$classid' and class='$class_name'";
                ...
                ?>
                      <tr>
                        <td><input type="checkbox" name="" value="<?php echo $rowallnotitem1 ?>" class="checkallextraitem1 itemExtra" data-type="item" data-classid="<?php echo $classid; ?>" data-class="<?php echo $class_name; ?>" data-gradeid="<?php echo $grad_id; ?>" data-userid="<?php echo $fetchuser_id; ?>" data-cloneid="<?php echo $get_clone_ides; ?>"></td>
                ...
                if ($statementallnotsubitem->rowCount() > 0) {
                  ...
                  foreach ($resultallnotsubitem as $rowallnotsubitem) {
                    ...
                    $sql522 = "SELECT count(*) FROM `extra_item_subitem_cl` WHERE item_id='$rowallnotsubitem1' AND data_type='subitem' and cloneid='$get_clone_ides' and class_id='$classid' and class='$class_name'";
                    ...
                    ?>
                      <tr>
                        <td><input type="checkbox" name="" value="<?php echo $rowallnotsubitem1 ?>" class="checkallextraitem1 itemExtra" data-type="subitem" data-classid="<?php echo $classid; ?>" data-class="<?php echo $class_name; ?>" data-gradeid="<?php echo $grad_id; ?>" data-userid="<?php echo $fetchuser_id; ?>" data-cloneid="<?php echo $get_clone_ides; ?>"></td>
              ...
              <div class="row">
                ...
                if ($hashstatement->rowCount() > 0) {
                  ...
                  foreach ($hashresult as $row1) {
                    ...
                    $fetch_hash_value = $connect->prepare("SELECT hash_off_value FROM `gradsheet_final_hashoff_cl` WHERE hash_off=? and user_id='$fetchuser_id' and class_id='$classid' and class_name='$class_name' and cloneid='$get_clone_ides'");
                ...
                ?>
                    ...
                    <div class="col-6 d-flex border justify-content-center">
                      <label style="text-align:center;"><?php echo $hash_names ?>
            ...
            <div class="col" style="justify-content: center;display: grid;">
              ...
              <div style="display:flex;justify-content: center;">
                ...
                <div class="dropdown dropup m-1">
                  ...
                  <button type="button" class="btn btncolor over_all_comment_add" id="selectLanguageDropdown2" data-bs-toggle="dropdown" title="Summary/Alibis" aria-expanded="false" data-bs-dropdown-animation style="padding:13px;">
              ...
              <div style="display: flex;justify-content: center;">
                ...
                <!-- <button type="button" style="margin:5px;" data-bs-toggle="modal" data-bs-target="#additional-training" class="btn btncolor" title="Add Additional Item For The Upcoming Classes" id="additional_training">Additional Task</button>
                <button style="margin:5px;" type="button" data-bs-toggle="modal" data-bs-target="#unaccomplish-training" title="Select Unaccoplish Task For This Class" class="btn btn-sm btncolor" id="Unaccomplish_but">Unaccomplished Task</button> -->
          ...
          <div class="card-body">
            <center>
              <table>
                ...
                <?php
                $sql53 = "SELECT count(*) FROM `notifications` WHERE user_id='$fetchuser_id' AND `type`='$class_name' AND `data`='$classid' AND extra_data='requesting to grade clone' and permission='$get_clone_ides'";
                $result53 = $connect->prepare($sql53);
                $result53->execute();
                $number_of_rows53 = $result53->fetchColumn();
                $sql54 = "SELECT count(*) FROM `grade_permission_clone` WHERE grade_id='$grad_id' AND `grade`='E' AND `status`='1' and clone_id='$get_clone_ides'";
                ...
                if (isset($_SESSION['permission']) && $permission['give_per_gradsheet'] == "1" && $number_of_rows53 > 0 && $number_of_rows54 == 0) { ?>
                  <button style="margin-left:10px" class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#ask_mark_per_admin"><i class="bi bi-bookmark-plus-fill"></i></button>
                <?php
                } else if (isset($_SESSION['permission']) && $permission['ask_per_gradsheet'] == "1") {
                ?>
                  <button style="margin-left:10px;" id="ask_mark_per1" class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#ask_mark_per"><i class="bi bi-bookmark-plus-fill"></i></button>
                <?php
                }
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <center>
                      ...
                      <!-- <button type="button" class="btn btn-danger"><i class="bi bi-lock-fill"></i></button>
                    <button type="button" class="btn btn-success"><i class="bi bi-unlock-fill"></i></button> -->
                    </center>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="container bg-white">
              <table class="table table-bordered src-table2 table-striped" id="unsearch1_re">
                ...
                <thead class="bg-dark">
                  <tr>
                    <th class="text-white"><input type="checkbox" id="select-all-unitem1"></th>
                    <!-- <th>ID</th> -->
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="container bg-white">
            <table class="table table-bordered table-striped table-hover src-table1" id="addsearch1_re">
              ...
              <!-- <form action="insert_additional1.php" method="post">
  ...
  <input type="hidden" id="item_id_addacc" name="">
  <input type="hidden" id="addStudentId" value="<?php echo $fetchuser_id; ?>" name="">
  <input type="hidden" name="" id="addcloeId" value="<?php echo $get_clone_ides; ?>">
  <input type="hidden" id="addGradeId" value="<?php echo $grad_id; ?>" name="">
  <input type="hidden" id="item_subitem_value" name="">
  <!--descipline log-->
  ...
  <div class="modal fade" id="ask_mark_per_admin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <center>
            <form action="give_gradeper_admin1.php" method="post">
              ...
              <input type="hidden" name="clone_id" value="<?php echo $get_clone_ides ?>">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <center>
            ...
            <input type="hidden" name="cloneId" id="addcloeId" value="<?php echo $get_clone_ides; ?>">
  ...
  <script>
    ...
    $("#update_gradsheet_but").hover(function() {
      $("#myFrm").attr("action", "<?php echo BASE_URL ?>includes/Pages/updateGradeSheetcl.php");
    });
    $("#submit_gradsheet_but").hover(function() {
      $("#myFrm").attr("action", "<?php echo BASE_URL ?>includes/Pages/submit_cloned_gradesheet.php");
    });
  </script>
  <script>
    function unsearch_task() {
      var input, filter, table, tr, td, i, txtValue;
      input = document.getElementById("unsearch1");
      filter = input.value.toUpperCase();
      table = document.getElementById("unsearchtable");
      tr = table.getElementsByTagName("tr");
      for (i = 0; i < tr.length; i++) {
        td = tr[i].getElementsByTagName("td")[1];
        if (td) {
  ...
  <script>
    ...
    $('.status').change(function() {
      ...
      if (std) {
        $.ajax({
          type: 'POST',
          url: 'insert_status1.php',
          data: 'status=' + val + '&std=' + std + '&class_name=' + class_name + '&class_id=' + class_id + '&get_clone_ides_val=' + get_clone_ides_val,
...
<script>
  $("#submit_gradsheet_but").on("click", function() {
    ...
    if (overall_all_com.trim() === '') {
      alert('Please Add Over All before submitting the form.');
      event.preventDefault(); // Prevent the form from submitting
      return;
    }
...
<script>
  function changeFont(text) {
    document.getElementById('contentt').style.fontFamily = text.value;
  }

  function changeSize(size) {
    let s = document.getElementById('contentt');
    s.style.fontSize = size.value + 'px';
  }
  $(document).ready(function() {
    $('#show-hide').on('click', function() {
      $('.ctdata').toggleClass('d-none');
    });
    $(document).on('click', '#bold-button', function() {
      let bol = document.getElementById('contentt').style.fontWeight;
      if (bol == 'normal') {
        document.getElementById('contentt').style.fontWeight = 'bold';
      } else {
        document.getElementById('contentt').style.fontWeight = 'normal';
      }

    });
    $(document).on('click', '#underline-button', function() {
      let underline = document.getElementById('contentt').style.textDecoration;
      if (underline !== 'underline') {
        document.getElementById('contentt').style.textDecoration = 'underline';
      } else {
        document.getElementById('contentt').style.textDecoration = 'none';
      }
    });
    $(document).on('click', '#italic-button', function() {
      let italic = document.getElementById('contentt').style.fontStyle;
      if (italic == 'normal') {
        document.getElementById('contentt').style.fontStyle = 'italic';
      } else {
        document.getElementById('contentt').style.fontStyle = 'normal';
      }

    });

    $('#align-left-button').on('click', function() {
      var textarea = $('#contentt');
...
<script>
  $(".addAddData").on("click", function() {
    ...
    var cloneId = $("#addcloeId").val();
    $.ajax({
      type: 'POST',
      url: '<?php echo BASE_URL; ?>includes/Pages/add_accomplish_additionalcl.php',
      data: {
...
<script>
  ...
  $(document).on('click', '.itemExtra', function() {
    ...
    if ($(this).is(":checked")) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo BASE_URL; ?>includes/Pages/addExtraItemSubcl.php',
        data: {
          itemId: itemId,
          itemType: itemType,
          gradeId: gradeId,
