<div id="Smallchat">
    <div class="Layout Layout-open Layout-expand Layout-right" style="background-color: #3F51B5;color: rgb(255, 255, 255);opacity: 5;border-radius: 10px;">
      <div class="Messenger_messenger">
        <div class="Messenger_header" style="background-color: rgb(22, 46, 98); color: rgb(255, 255, 255);"> 
          <h4 class="Messenger_prompt text-light">How can we help you?</h4> <span class="chat_close_icon"><i class="bi bi-x-circle" aria-hidden="true"></i></span> </div>
        <div class="Messenger_content">
          <div class="Messages">
            
              <div class="Message-text" style="background: aliceblue;
    width: 50%;
    float: left;">
                                        <h1>hello</h1>
                                    </div>
    ...
    float: right;">
          ...
          <div class="Input Input-blank">
            ...
            <button class="Input_button Input_button-send">
              <div class="Icon" style="width: 18px; height: 18px;">
                <i class="bi bi-send" style="font-size:large;"></i>
                </svg>
              </div>
            </button>
          </div>
    ...
    <div class="chat_on"> <span><img src="<?php echo BASE_URL;?>assets/svg/chat/msg1.png"><i class="fa fa-comments" aria-hidden="true"></i></span> </div>
    <!--===============CHAT ON BUTTON END===============-->
  </div>