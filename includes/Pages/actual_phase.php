        ...
        <div class="col-lg-10 mb-3 mb-lg-5">
          ...
          <div class="card card-hover-shadow h-100" style="border:0.001rem solid #dddddd;">
            ...
            <div class="card-body">
              ...
              ?></div>
                <form action="selected_phase_actual.php" method="post" style="width:100%;" enctype="multipart/form-data">
                    ...
                    foreach($select_ctpsre2 as $select_ctpsrow2)
                      {
                        ...
                        $sql = "SELECT count(*) FROM `actual_phase` WHERE phase = ?"; 
...
<hr>
              <br><br>         <table class="table table-striped table-bordered">
                    ...
                    <?php 
                    $query112 = "SELECT * FROM actual_phase where ctp_id='$ctp'";
                      ...
                      <tr>
                       ...
                       <td>
                       <a href="actual_phase_del.php?id=<?php echo $del_id_phase?>"><i class="bi bi-trash-fill text-danger"></i></a>
