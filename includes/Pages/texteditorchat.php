...
<body>
  ...
  <div class="editor-container-fluid">
    ...
    <form action="<?php echo BASE_URL; ?>includes/Pages/save_editor_data.php?page=<?php echo $_REQUEST['page'] ?>" method="post" enctype="multipart/form-data">
      ...
      <div class="container-fluid" style="height:50px;">
        ...
        <div class="row" style="float: right;">
          <button name="pagesubmit" type="button" data-bs-toggle="modal" data-bs-target="#pageper" style="float:right; color:black;" class="btn nav-item"><i class="bi bi-download" style="color:black;"></i>Save Changes</button>
        </div>
