...
<body>
    <div class="text-container">
        <div class="options">
            <!-- Text Format -->
            <button id="bold" class="option-button button format">
          ...
          <i class="fa-solid fa-outdent"></i>
            ...
            <!-- Headings -->
            <select id="formatBlock" class="adv-option-button select">
          ...
          <option value="H6">H6</option>
            ...
            <!-- Font -->
            <select id="fontName" class="adv-option-button select"></select>
            <select id="fontSize" class="adv-option-button select"></select>
