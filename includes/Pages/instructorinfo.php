...
<div class="col-lg-10 mb-3 mb-lg-5">
  ...
  <div class="card card-hover-shadow h-100" style="border:0.001rem solid #dddddd;">
    ...
    <div class="card-body">
      ...
      <button class="btn btn-secondary" title="Check Reason For Unlock Gradesheet" style="font-size: large;padding: 5px;padding-top: 0px;padding-bottom: 0px;font-weight: bold;" data-bs-toggle="modal" data-bs-target="#lockReasonModal"><i class="bi bi-card-list"></i></button>

      <?php $fetch_value_unlock = $connect->query("SELECT reason
      FROM unclock_gradsheet_reason where g_id='$grad_id'
      ORDER BY id DESC
      LIMIT 1;");
      ...
      echo '<span title='.$fetch_value_unlockdata.' class="badge bg-soft-danger text-danger" style="margin:5px;font-size:large;">'.substr($fetch_value_unlockdata,0,110).'</span>';  ?>
      <hr style="margin: 15px;">

      <?php
         $fetch_value_cleardata='';
              $fetch_value_clear = $connect->query("SELECT reason
             FROM gradeaheet_clear_reason where gradesheetId='$grad_id'
             ORDER BY id DESC
             LIMIT 1;");
             ...
             echo '<button class="btn btn-secondary" title="Check Reason For Clear Gradesheet" style="font-size: large;padding: 5px;padding-top: 0px;padding-bottom: 0px;font-weight: bold;margin-right: 5px;" data-bs-toggle="modal" data-bs-target="#ClearReasonModal"><i class="bi bi-card-list"></i></button>';
             echo '</div>';
      ?>
      ...
      <div style="width:100%; cursor: pointer;" id="user_Data_table" data-bs-toggle="modal" data-bs-target="#inst_modal">



        <div class="text">
          <?php
          $get_ins = "SELECT * FROM gradesheet where user_id='$fetchuser_id' and course_id='$std_course1' AND class_id='$classid' AND phase_id='$phase_id' AND class='$class_name'";
        ...
        <div class="form-row">
          <div class="input-data">
            <label class="text-dark" style="font-weight: bold;font-size:x-large;"><?php echo $vehicleNameData1; ?> : <span class="text-secondary
              " style="font-weight:bold; font-size:x-large; font-family: cursive;"><?php echo $name2 ?></span></label>
...
<!-- <hr> -->
      ...
      ?>
        ...
        <div class="" style="float:right;margin: 5px;">
          ...
          //    LIMIT 1;");
          //    $fetch_value_cleardata = $fetch_value_clear->fetchColumn();
          //    echo '<span class="badge bg-danger" style="float:right;margin:12px;font-size:large;">'.$fetch_value_cleardata.'</span>';  
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div style="float: right;">
                      <input type="button" id="Ask_to_unlock" value="Ask" class="btn btn-outline-success" style="font-size:large; font-weight:bold;">
        ...
        <center>
          ...
          <table style="width:100%;" id="user_Data_table">
            ...
            <tr>
              ...
              <form action="stu_Data.php" method="get" id="user_Data_table">
                ...
                <td style="width:50%;"><label class="text-dark" style="font-weight:bolder; margin-top: -15px;"><?php echo $vehicleNameData1; ?></label>
            ...
            <tr>
              ...
              <td><label class="text-dark" style="font-weight:bolder;">Date</label><input required class="form-control" type="date" id="date_filled1" value="<?php if ($st_date != "") {
...
<!--Lock Reason Modal -->
<div id="lockReasonModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <div class="modal-body">
        <table class="table table-bordered table-striped table-hover">
          ...
          <tbody style="text-align: center;">
            <?Php
              $get_reasonunlock = "SELECT * FROM unclock_gradsheet_reason where g_id='$grad_id' order by id DESC";
...
<!--Clear Reason Modal -->
<div id="ClearReasonModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <table class="table table-bordered table-striped table-hover">
          ...
          <tbody style="text-align: center;">
          <?Php
              $get_reasonunlock1 = "SELECT * FROM gradeaheet_clear_reason where gradesheetId='$grad_id' order by id DESC";
