...
if (isset($_REQUEST['altertId'])) {
    ...
    $html .= '<div class="modal-header" style="background:'.$titledat['color'].'">
                <img src="'.BASE_URL.'assets/svg/alert/'.$titledat['alert_icon'].'" id="alert_Cate_image" class="mb-2" style="height:50px; margin-top:-20px; padding:5px;">&nbsp;<h1 class="heading"  style="margin-bottom:25px; font-size:xx-large; color:'.$titledat['textcolor'].'">'.$titledat['alert_type'].'</h1>
