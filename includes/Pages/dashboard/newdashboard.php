      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-12 mb-3 mb-lg-5">
          ...
          <div class="card card-hover-shadow h-100" style="border:0.001rem solid #dddddd;">
            ...
            <a class="btn btn-soft-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Go To Home Page" style="color:black; text-decoration:none;" href="<?php echo BASE_URL;?>includes/Pages/Home.php"><i class="bi bi-arrow-left"></i></a>
            <h1 class="card-subtitle text-dark" style="font-size: x-large !important;margin: 5px;">
              <?php 
                        if($fetchuser_id != 0) {
