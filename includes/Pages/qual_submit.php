...
if(empty($ctp_id)){
  ...
  header("Location:qual_data.php");
  }else{
if (isset($itemcheck)) {
    foreach ($itemcheck as $itemchecks) {

        $sql_e = "INSERT INTO qual_data(item,stud_id,ctp_id) VALUES ('$itemchecks','$stud_db_id','$ctp_id')";
...
if (isset($subitemcheck)) {
    foreach ($subitemcheck as $subitemchecks) {
        ...
        $sql_eq = "INSERT INTO qual_data(subitem,stud_id,ctp_id) VALUES ('$subitemchecks','$stud_db_id','$ctp_id')";
