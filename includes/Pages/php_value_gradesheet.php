<?php
    ...
    if (isset($_GET['id'])) {
      ...
      $phase_ID = $connect->query("SELECT phase FROM $class_name where id='$classid'");
      $phaseIdData = $phase_ID->fetchColumn();
    ...
    ?>
      <?php
                    ...
                    ?>
                       <input type="hidden" value="<?php echo $user_id?>" id="session_id"> <input type="hidden" value="<?php echo $fetchuser_id?>" id="get_std_id1">
                       <input type="hidden" value="<?php echo $grad_id?>" id="gradsheet_get_id"><?php
                     $get_ins1 = "SELECT * FROM gradesheet where user_id='$fetchuser_id' and course_id='$std_course1' AND class_id='$classid' AND phase_id='$phase_id' AND class='$class_name' and instructor='$user_id'";
            ...
            $(".status").attr('disabled', true);
               $(".append_data1").hide(); $(".radio3").attr('disabled', true);$(".append_value").attr('disabled', true);
      ...
      if ($row1['status'] == '1') { ?>
        <script>
          $(document).ready(function() {
            $(".myRadio").attr('disabled', true);
            $(".myRadio1").attr('disabled', true);
            // $(".Myitem td").removeClass("checkRadio");
            // $(".Myitem td input").removeClass("myRadio1");
            ...
            $("#date_filled1").attr('disabled', true);
            $("#submit_gradsheet_but").attr('disabled', true);
            $("#update_gradsheet_but").attr('disabled', true);
  ...
  <script>
    ...
    $(document).on("click", "#unlock_gradsheet", function() {
      ...
      check_admin_reason = $("#check_admin_reason").val();
    ...
    if (check_admin_username == "") {
      ...
      if (check_admin_reason == "") {
        alert("please give reason to Unlock..");
      }
      $.ajax({
        type: 'POST',
        url: 'unlock_admin_gradsheet.php',
        data: 'gradesheetid=' + gradesheetid + '&check_admin_username=' + check_admin_username + '&check_admin_password=' + check_admin_password+ '&check_admin_reason=' + check_admin_reason+ '&useridlogin=' + useridlogin,
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.main_u1').change(function() {
       
       if ($(this).is(':checked')) {
         $('.Myitem1').css("background-color", "#ed4c78");
         $('.Myitem1').css("color", "white");
         $('.subitem_tr1').css("background-color", "#ed4c78");
         $('.subitem_tr1').css("color", "white");
     // Find the radio button with the data-value attribute and add the data-checked attribute to it
     $('input[type="radio"][data-value1="U"]').prop('checked', true);
   } else {
     // If radioButton1 is not selected, remove the data-checked attribute from the radio button with the data-value attribute
     $('input[type="radio"][data-value1="U"]').prop('checked', false);
   }
     });
     $('.main_u2').change(function() {
       
       if ($(this).is(':checked')) {
         $('.Myitem2').css("background-color", "#ed4c78");
         $('.Myitem2').css("color", "white");
         
     // Find the radio button with the data-value attribute and add the data-checked attribute to it
     $('input[type="radio"][data-value2="U"]').prop('checked', true);
   } else {
     // If radioButton1 is not selected, remove the data-checked attribute from the radio button with the data-value attribute
     $('input[type="radio"][data-value2="U"]').prop('checked', false);
   }
     });
      ...
      $('.main_f1').change(function() {
       
       if ($(this).is(':checked')) {
         $('.Myitem1').css("background-color", "#f5ca99");
         $('.Myitem1').css("color", "white");
         $('.subitem_tr1').css("background-color", "#f5ca99");
         $('.subitem_tr1').css("color", "white");
     // Find the radio button with the data-value attribute and add the data-checked attribute to it
     $('input[type="radio"][data-value1="F"]').prop('checked', true);
   } else {
     // If radioButton1 is not selected, remove the data-checked attribute from the radio button with the data-value attribute
     $('input[type="radio"][data-value1="F"]').prop('checked', false);
   }
     });
     $('.main_f2').change(function() {
       
       if ($(this).is(':checked')) {
         $('.Myitem2').css("background-color", "#f5ca99");
         $('.Myitem2').css("color", "white");
         
     // Find the radio button with the data-value attribute and add the data-checked attribute to it
     $('input[type="radio"][data-value2="F"]').prop('checked', true);
   } else {
     // If radioButton1 is not selected, remove the data-checked attribute from the radio button with the data-value attribute
     $('input[type="radio"][data-value2="F"]').prop('checked', false);
   }
     });
     ...
     $('.main_g1').change(function() {
       
       if ($(this).is(':checked')) {
         $('.Myitem1').css("background-color", "#71869d");
         $('.Myitem1').css("color", "white");
         $('.subitem_tr1').css("background-color", "#71869d");
         $('.subitem_tr1').css("color", "white");
     // Find the radio button with the data-value attribute and add the data-checked attribute to it
     $('input[type="radio"][data-value1="G"]').prop('checked', true);
   } else {
     // If radioButton1 is not selected, remove the data-checked attribute from the radio button with the data-value attribute
     $('input[type="radio"][data-value1="G"]').prop('checked', false);
   }
     });
     $('.main_g2').change(function() {
       
       if ($(this).is(':checked')) {
         $('.Myitem2').css("background-color", "#71869d");
         $('.Myitem2').css("color", "white");
         
     // Gind the radio button with the data-value attribute and add the data-checked attribute to it
     $('input[type="radio"][data-value2="G"]').prop('checked', true);
   } else {
     // If radioButton1 is not selected, remove the data-checked attribute from the radio button with the data-value attribute
     $('input[type="radio"][data-value2="G"]').prop('checked', false);
   }
     });
     ...
     $('.main_v1').change(function() {
       
       if ($(this).is(':checked')) {
         $('.Myitem1').css("background-color", "#00c9a7");
         $('.Myitem1').css("color", "white");
         $('.subitem_tr1').css("background-color", "#00c9a7");
         $('.subitem_tr1').css("color", "white");
     // Find the radio button with the data-value attribute and add the data-checked attribute to it
     $('input[type="radio"][data-value1="V"]').prop('checked', true);
   } else {
     // If radioButton1 is not selected, remove the data-checked attribute from the radio button with the data-value attribute
     $('input[type="radio"][data-value1="V"]').prop('checked', false);
   }
     });
     $('.main_v2').change(function() {
       
       if ($(this).is(':checked')) {
         $('.Myitem2').css("background-color", "#00c9a7");
         $('.Myitem2').css("color", "white");
         
     // Vind the radio button with the data-value attribute and add the data-checked attribute to it
     $('input[type="radio"][data-value2="V"]').prop('checked', true);
   } else {
     // If radioButton1 is not selected, remove the data-checked attribute from the radio button with the data-value attribute
     $('input[type="radio"][data-value2="V"]').prop('checked', false);
   }
     });
     ...
     $('.main_e1').change(function() {
       
       if ($(this).is(':checked')) {
         $('.Myitem1').css("background-color", "#377dff");
         $('.Myitem1').css("color", "white");
         $('.subitem_tr1').css("background-color", "#377dff");
         $('.subitem_tr1').css("color", "white");
     // Find the radio button with the data-value attribute and add the data-checked attribute to it
     $('input[type="radio"][data-value1="E"]').prop('checked', true);
   } else {
     // If radioButton1 is not selected, remove the data-checked attribute from the radio button with the data-value attribute
     $('input[type="radio"][data-value1="E"]').prop('checked', false);
   }
     });
     $('.main_e2').change(function() {
       
       if ($(this).is(':checked')) {
         $('.Myitem2').css("background-color", "#377dff");
         $('.Myitem2').css("color", "white");
         
     // Eind the radio button with the data-value attribute and add the data-checked attribute to it
     $('input[type="radio"][data-value2="E"]').prop('checked', true);
   } else {
     // If radioButton1 is not selected, remove the data-checked attribute from the radio button with the data-value attribute
     $('input[type="radio"][data-value2="E"]').prop('checked', false);
   }
     });
     ...
     $('.main_n1').change(function() {
       
       if ($(this).is(':checked')) {
         $('.Myitem1').css("background-color", "white");
         $('.Myitem1').css("color", "black");
         $('.subitem_tr1').css("background-color", "white");
         $('.subitem_tr1').css("color", "black");
     // Find the radio button with the data-value attribute and add the data-checked attribute to it
     $('input[type="radio"][data-value1="N"]').prop('checked', true);
   } else {
     // If radioButton1 is not selected, remove the data-checked attribute from the radio button with the data-value attribute
     $('input[type="radio"][data-value1="N"]').prop('checked', false);
   }
     });
     $('.main_n2').change(function() {
       
       if ($(this).is(':checked')) {
         $('.Myitem2').css("background-color", "white");
         $('.Myitem2').css("color", "black");
  ...
  <script>
    ...
    $(document).on("click", "#ask_permssion_marks", function() {
      ...
      var ins = $("#session_id").val();
      var std = $("#get_std_id1").val();
      var class_name = $("#class_name").val();
      var class_id = $("#class_id").val();
   
      $.ajax({
              type: 'POST',
              url: 'ask_perm_grade.php',
              data: 'std=' + std+'&inst='+ins+'&class_name='+class_name+'&class_id='+class_id,
              success: function(response) {
               alert(response);
                //  $("#ask_mark_per1").show();
                //  $("#update_gradsheet_but").attr('disabled', true);
