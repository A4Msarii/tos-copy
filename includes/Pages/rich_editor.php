...
<body>
  <div class="container-fluid">
    <div class="options">
      ...
      <button type="button" id="bold" class="option-button format btn btn-ghost-secondary">
        <i class="bi bi-type-bold"></i>
      </button>
      <button type="button" id="italic" class="option-button format btn btn-ghost-secondary">
        <i class="bi bi-type-italic"></i>
      </button>
      <button type="button" id="underline" class="option-button format btn btn-ghost-secondary">
        <i class="bi bi-type-underline"></i>
      </button>
      <button type="button" id="strikethrough" class="option-button format btn btn-ghost-secondary">
        <i class="bi bi-type-strikethrough"></i>
      </button>
      <!-- <button type="button" id="superscript" class="option-button script btn btn-ghost-secondary">
          <i class="bi bi-superscript"></i>
        </button>
        <button type="button" id="subscript" class="option-button script btn btn-ghost-secondary">
          <i class="bi bi-subscript"></i>
        </button> -->

      <!-- List -->
      <button type="button" id="insertOrderedList" class="option-button btn btn-ghost-secondary">
        <i class="bi bi-list-ol"></i>
      </button>
      <button type="button" id="insertUnorderedList" class="option-button btn btn-ghost-secondary">
        <i class="bi bi-list"></i>
      </button>
      <button type="button" class="btn" id="show-hide"><i class="bi bi-three-dots-vertical"></i></button>
      <!-- Undo/Redo -->
      <div class="togle d-none options">
        <button type="button" id="undo" class="option-button btn btn-ghost-secondary">
          <i class="bi bi-arrow-counterclockwise"></i>
        </button>
        <button type="button" id="redo" class="option-button btn btn-ghost-secondary">
          <i class="bi bi-arrow-clockwise"></i>
        </button>

        <!-- Link -->
        <button type="button" id="createLink" class="adv-option-button btn btn-ghost-secondary">
        ...
        <!-- Alignment -->
        <button type="button" id="justifyLeft" class="option-button align btn btn-ghost-secondary">
          <i class="bi bi-justify-left"></i>
        </button>
        <button type="button" id="justifyCenter" class="option-button align btn btn-ghost-secondary">
          <i class="bi bi-text-center"></i>
        </button>
        <button type="button" id="justifyRight" class="option-button align btn btn-ghost-secondary">
          <i class="bi bi-justify-right"></i>
        </button>
        <button type="button" id="justifyFull" class="option-button align btn btn-ghost-secondary">
          <i class="bi bi-justify"></i>
        </button>
        <!-- <button type="button" id="indent" class="option-button spacing btn btn-ghost-secondary">
          <i class="fa-solid fa-indent"></i>
        </button>
        <button type="button" id="outdent" class="option-button spacing btn btn-ghost-secondary">
    ...
    <?php if ($comments != "") { ?>
    <div id="text-input" id="contentt" contenteditable="true"><?php echo $comments; ?></div>
    <?php } else { ?>
      <div id="text-input" id="contentt" contenteditable="true"></div>
      <?php } ?>
  </div>
  <!--Script-->
