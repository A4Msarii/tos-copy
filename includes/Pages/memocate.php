  ...
  <div>
    <div class="content container-fluid" style="height: 30rem;">
      ...
      <div class="page-header" style="padding: 0px;">
        <h1 class="text-success">Memo Category</h1>
      </div>
      <!-- End Page Header -->
    </div>
  </div>
      ...
      <div class="col-lg-10 mb-3 mb-lg-5">
        ...
        <div class="card card-hover-shadow h-100" style="border:0.001rem solid #dddddd;">
          ...
          <div class="card-body">
            ...
            <center>
              <form class="insert-categorys" id="category_form" method="post" action="insert_memo_category.php" style="width:700px;">
                <div class="input-field">
                  <table class="table table-bordered" id="table-field-memocate">
                    <tr>
                ...
                <center>
                  <button style="margin:5px;" class="btn btn-success" type="submit" id="category_submit" name="savememo">Submit</button>
                </center>
              </form>
            </center>
              ...
              ?>
                  <tr>
                    ...
                    <td><a class="btn btn-soft-success btn-xs" href="" onclick="document.getElementById('cid').value='<?php echo $row1['id'] ?>';
                                        document.getElementById('category_name').value='<?php echo $row1['category']; ?>';document.getElementById('category_mark').value='<?php echo $row1['marks']; ?>';
                                      " data-bs-toggle="modal" data-bs-target="#editcategory"><i class="bi bi-pen-fill"></i></a>


                      <a class="btn btn-soft-danger btn-xs" href="memocategory-delete.php?id=<?php echo $id ?>"><i class="bi bi-trash-fill"></i></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <center>
          <form method="post" action="edit_memocategory.php">
            ...
            <label class="text-dark" style="float:left;">Mark</label>
            <input class="form-control" type="text" name="mark" value="" id="category_mark">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#add_category").click(function() {
      if (a <= max) {
        $("#table-field-memocate").append(html);
        a++;
      }
    });
    $("#table-field-memocate").on('click', '#remove_category', function() {
