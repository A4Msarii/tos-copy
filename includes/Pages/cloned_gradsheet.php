...
$fetch_overall_grade="";
//fetch ins for form
$q2= "SELECT * FROM users where role='instructor' or role = 'instructors'";
     ...
     <div>
      <div class="content container-fluid" style="height: 25rem;">
        ...
        <div class="page-header page-header-light">
          <h1 class="text-success">Cloned Gradesheet</h1>
        ...
        <div class="col-lg-10 mb-3 mb-lg-5">
          ...
          <div class="card card-hover-shadow h-100" style="border:0.001rem solid #dddddd;">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-6">
                <!-- <h5 style="font-weight:bolder;">Course name : <span class="text-success" style="font-size: unset; text-decoration: underline;"><?php echo $std_course.'<br>' ?></span></h5> -->
               <?php if(isset($_REQUEST['clone_ides'])){
                              ...
                              // if class name is set
                                  if(isset($_GET['class_name'])){
                                    ...
                                    $class_name=$_SESSION['class_name_Sess'];
                                      ...
                                      // echo '<h5>Class : <span class="text-success" style="font-size: unset; text-decoration: underline;">'.$class.'-C'.$get_clone_ides.'</span> </h5>';
                                      ...
                                      <div class="d-flex align-items-center">
                                        ...
                                        ?>
                                          ...
                                          <div class="flex-grow-1 ms-3">
                                            ...
                                            <span class="card-text text-body"><?php echo $class.'-C'.$get_clone_ides;?></span>
                                          </div>
                                        </div>
                                      <?php 
                                         $get_ins1="SELECT * FROM notifications where `type`='$class_name' AND `data`='$classid' AND `to_userid`='$user_id' AND user_id='$fetchuser_id' and extra_data='cloned_gradsheet' and permission='$get_clone_ides'";
                            ...
                            <?php
                                ...
                                $statement = $connect->prepare($fet);
                                    ...
                                    foreach($result as $row1)
                                    {
                                      ...
                                      $fetch_grade1= $connect->prepare("SELECT id FROM cloned_gradesheet where class=? and class_id=? and course_id=? and phase_id=? and user_id=?");
                                      ...
                                      $q = $connect->prepare("SELECT shortsim FROM $table_name1 WHERE id=?");
                                            ...
                                            $q = $connect->prepare("SELECT shortacademic FROM $table_name1 WHERE id=?");
                                                ...
                                                $q = $connect->prepare("SELECT shorttest FROM $table_name1 WHERE id=?");
                                                        ...
                                                        <li style="text-decoration: none;" class="<?php echo $class?>"><?php  echo $name ; ?></li></ul>
                              <?php      }
                                    ?>
                  </div>
            </div>
            ...
            //fetch all vechile for form
              ...
              <!-- form starts here -->
                    ...
                    <table style="width:100%;" id="user_Data_table">
                        <tr>
                                  <?php 
                                  //notification updation code
                                if(isset($_REQUEST['std_id'])){
                                    $fetchuser_id=$_REQUEST['std_id'];
                                ...
                                //clone id 
                                 ?>
                                            ...
                                            <td style="width: 50%;"><label class="text-dark" style="font-weight:bolder;">Id</label>
                                            <input class="form-control" type="text" name="stud_id" readonly value="<?php echo $fetchid?>" style="background-color: #bfcfe09e;"></td>
                                            <td style="width: 50%;"><label class="text-dark" style="font-weight:bolder;">Name</label>
                                              <input class="form-control" type="text" name="stud_name" readonly value="<?php echo $fetchnickname?>" style="background-color: #bfcfe09e;"></td>
                                            </tr>
                                              <tr>
                                              <td style="width: 50%;"><label class="text-dark" style="font-weight:bolder;">Role</label>
                                                <input class="form-control" type="text" name="stud_role" readonly value="<?php echo $fetchrole?>" style="background-color: #bfcfe09e;"></td>
                                              <td style="width: 50%;"><label class="text-dark" style="font-weight:bolder;">Phone</label>
                                                <input class="form-control" type="text" name="stud_phone" readonly value="<?php echo $fetchphone?>" style="background-color: #bfcfe09e;"></td>
                                              </tr>
                                            <tr>
                            <?php
                                            //fetch data from gradsheet if set
                                            $std_in="";
                                            $vec_id="";
                                            $over_all_grade_per="";
                              ...
                              $added_ins="";
                              $get_ins="SELECT * FROM notifications where `type`='$class_name' AND `data`='$classid' AND user_id='$fetchuser_id' and extra_data='cloned_gradsheet'";
                              ...
                              $re1 = $get_insst->fetchAll();
                                ...
                                ?>
                                <form action="stu_Data1.php" method="get">
                                <input type="hidden" name="st_id" value="<?php echo $fetchuser_id?>">
                                    ...
                                    <input type="hidden" name="clo_id" value="<?php echo $get_clone_ides?>">
                                  <td style="width: 50%;"><label class="text-dark" class="form-label" for="instructor_id" style="font-weight:bolder;">Instructor<span style="color:red"> (select instructor will get notification)</span></label>
                                  ...
                                  <td style="width: 50%;"><label class="text-dark" style="font-weight:bolder;">Vehicle</label>
                                    ...
                                    <td style="width: 50%;"><label class="text-dark" style="font-weight:bolder;">Time</label><input class="form-control" type="time" id="time_filled" value="<?php if(isset($st_time)){$date = date("H:i", strtotime($st_time)); echo "$date";}else{echo "";} ?>" name="time"></td>
                                   <!-- set inserted value of date -->
                                    <td style="width: 50%;"><label class="text-dark" style="font-weight:bolder;">Date</label><input class="form-control" type="date" id="date_filled" value="<?php if(isset($st_date)){echo date('Y-m-d',$st_date);}else{echo "";}?>" name="date"></td>
                                    </tr>
                                    <tr>
                    <td>
                      <label class="text-dark" style="font-weight:bolder;">Duration</label>
                      <label class="text-dark" style="font-weight:bolder;">Duration</label>
                   
                   <input type="number" id="duration-hours" name="duration_hours" value="<?php if (isset($st_duration_hr)) { echo $st_duration_hr;} else {echo "00";}?>" min="0" max="23" placeholder="hh" style="width: 50px;" oninput="this.value = this.value.slice(0, 2)" oninput="this.value = Math.min(Math.max(parseInt(this.value), 0), 12)">
                   
                   :
                   <input type="number" id="duration-minutes" name="duration_minutes" value="<?php if (isset($st_duration_min)) { echo $st_duration_min;} else {echo "00";}?>" min="0" max="59" placeholder="mm" style="width: 50px;" oninput="this.value = this.value.slice(0, 2)" oninput="this.value = Math.min(Math.max(parseInt(this.value), 0), 60)">
                    </td>
                  </tr> 
                              </table>
                              <br>
                             ...
                             <?php
                                ...
                                $re = $lockst->fetchAll();
                                    ...
                                    {
                                      ?>
                                      <input type="hidden" id="gradsheet_get_id" value="<?php echo $row['id']?>">
                                ...
                                <?php
                                  ...
                                  <a class="btn btn-success" id="ask_for_unlock" data-bs-toggle="modal" data-bs-target="#ask_for_unlock_modal" style="float:right;">Ask To Unlock</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
              ...
              <div class="container">
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <form method="post" action="submit_cloned_gradesheet.php">
                    ...
                    <input class="form-control" type="hidden" name="stud_db_id" id="stud_db_id" value="<?php echo $fetchuser_id?>">
                              ...
                              if($statement->rowCount() > 0)
                                {
                                  ...
                                  {
                                    $item_db_id=$row['id'];
                                    $fetch_grade= $connect->prepare("SELECT grade FROM `item_clone_gradesheet` WHERE item_id=? AND user_id=? and cloned_id='$get_clone_ides'");
                                    ...
                                    <input style="margin: 5px; padding: 5px;" gradeval="U<?php echo $sn112?>" number="<?php echo $sn112?>" type="radio" class="myRadio1" <?php if($grade=="U") {echo "checked";}?> value="U" name="grade[item<?php echo $item_id?>]"/>
                                    <label for="item-U">U</label>
                                    <input style="margin: 5px; padding: 5px;" gradeval="F<?php echo $sn112?>" number="<?php echo $sn112?>" type="radio" class="myRadio1" <?php if($grade=="F") {echo "checked";}?> value="F" name="grade[item<?php echo $item_id?>]"/>
                                    <label for="item-F">F</label>
                                    <input style="margin: 5px; padding: 5px;" gradeval="G<?php echo $sn112?>" number="<?php echo $sn112?>" type="radio" class="myRadio1" <?php if($grade=="G") {echo "checked";}?> value="G" name="grade[item<?php echo $item_id?>]"/>
                                    <label for="item-G">G</label>
                                    <input style="margin: 5px; padding: 5px;" gradeval="V<?php echo $sn112?>" number="<?php echo $sn112?>" type="radio" class="myRadio1" <?php if($grade=="V") {echo "checked";}?> value="V" name="grade[item<?php echo $item_id?>]"/>
                                    <label for="item-V">V</label>
                                    <input style="margin: 5px; padding: 5px;" gradeval="E<?php echo $sn112?>" number="<?php echo $sn112?>" type="radio" class="myRadio1" <?php if($grade=="E") {echo "checked";}?> value="E" name="grade[item<?php echo $item_id?>]"/>
                                    <label for="item-E">E</label>
                                    <input style="margin: 5px; padding: 5px;" gradeval="N<?php echo $sn112?>" number="<?php echo $sn112?>" type="radio" class="myRadio1" <?php if($grade=="N") {echo "checked";}?> value="N" name="grade[item<?php echo $item_id?>]"/>
                                    ...
                                    <?php
                                      ...
                                      if($statement->rowCount() > 0)
                                        {
                                          ...
                                          foreach($result1 as $row1)
                                          {
                                            ...
                                            $fetch_subgrade= $connect->prepare("SELECT grade FROM `subitem_cloned_gradesheet` WHERE subitem_id=? AND user_id=? and cloned_id='$get_clone_ides'");
                                      ...
                                      <tr id="color_tr1<?php echo $sn116.$sn112?>" style="<?php echo $bac_ground1?>">
                                        ...
                                        <td style="text-align:center;"><?php echo $sub_value=$name_sub;
                                    ...
                                    <td style="display: flex;">
                                    <input style="margin: 5px; padding: 5px;" type="radio" value="U" number="<?php echo $sn116?>" number2="<?php echo $sn112?>" class="myRadio2" <?php if($grade1=="U") {echo "checked";}?> name="grade[<?php echo $sub_value.$item_id?>]"/><label for="subitem-U">U</label>
                                    <input style="margin: 5px; padding: 5px;" type="radio" value="F" number="<?php echo $sn116?>" number2="<?php echo $sn112?>" class="myRadio2" <?php if($grade1=="F") {echo "checked";}?> name="grade[<?php echo $sub_value.$item_id?>]"/><label for="subitem-F">F</label>
                                    <input style="margin: 5px; padding: 5px;" type="radio" value="G" number="<?php echo $sn116?>" number2="<?php echo $sn112?>" class="myRadio2" <?php if($grade1=="G") {echo "checked";}?> name="grade[<?php echo $sub_value.$item_id?>]"/><label for="subitem-G">G</label>
                                    <input style="margin: 5px; padding: 5px;" type="radio" value="V" number="<?php echo $sn116?>" number2="<?php echo $sn112?>" class="myRadio2" <?php if($grade1=="V") {echo "checked";}?> name="grade[<?php echo $sub_value.$item_id?>]"/><label for="subitem-V">V</label>
                                    <input style="margin: 5px; padding: 5px;" type="radio" value="E" number="<?php echo $sn116?>" number2="<?php echo $sn112?>" class="myRadio2" <?php if($grade1=="E") {echo "checked";}?> name="grade[<?php echo $sub_value.$item_id?>]"/><label for="subitem-E">E</label>
                                    <input style="margin: 5px; padding: 5px;" type="radio" value="N" number="<?php echo $sn116?>" number2="<?php echo $sn112?>" class="myRadio2" <?php if($grade1=="N") {echo "checked";}?> name="grade[<?php echo $sub_value.$item_id?>]"/><label for="subitem-N">N</label>
                                    </td>
                                          </tr>
                                      <?php  
                                      $sn116++;
                  ...
                  <div class="col-6">
                  <?php if ($comments != "") { ?>
                          <textarea style="height: 500px; width:auto;" name="comment" placeholder="comments" rows="4" id="comment"><?php echo $comments ?></textarea>
                        <?php } else { ?>
      ...
      <div class="options">
        ...
        <button id="strikethrough" class="option-button format btn btn-ghost-secondary">
          <i class="bi bi-type-strikethrough"></i>
        </button>
        <!-- <button id="superscript" class="option-button script btn btn-ghost-secondary">
          <i class="bi bi-superscript"></i>
        </button>
        <button id="subscript" class="option-button script btn btn-ghost-secondary">
          <i class="bi bi-subscript"></i>
        </button> -->

        <!-- List -->
        <button id="insertOrderedList" class="option-button btn btn-ghost-secondary">
          <i class="bi bi-list-ol"></i>
        </button>
        <button id="insertUnorderedList" class="option-button btn btn-ghost-secondary">
          <i class="bi bi-list"></i>
        </button>

        <!-- Undo/Redo -->
        <button id="undo" class="option-button btn btn-ghost-secondary">
          <i class="bi bi-arrow-counterclockwise"></i>
        </button>
        <button id="redo" class="option-button btn btn-ghost-secondary">
          <i class="bi bi-arrow-clockwise"></i>
        </button>

        <!-- Link -->
        <button id="createLink" class="adv-option-button btn btn-ghost-secondary">
        ...
        <!-- Alignment -->
        <button id="justifyLeft" class="option-button align btn btn-ghost-secondary">
          <i class="bi bi-justify-left"></i>
        </button>
        <button id="justifyCenter" class="option-button align btn btn-ghost-secondary">
          <i class="bi bi-text-center"></i>
        </button>
        <button id="justifyRight" class="option-button align btn btn-ghost-secondary">
          <i class="bi bi-justify-right"></i>
        </button>
        <button id="justifyFull" class="option-button align btn btn-ghost-secondary">
          <i class="bi bi-justify"></i>
        </button>
        <!-- <button id="indent" class="option-button spacing btn btn-ghost-secondary">
          <i class="fa-solid fa-indent"></i>
        </button>
        <button id="outdent" class="option-button spacing btn btn-ghost-secondary">
          <i class="fa-solid fa-outdent"></i>
        </button> -->

        <!-- Headings -->
        <select id="formatBlock" class="adv-option-button form-control" style="width:auto;">
        ...
        <!-- Font -->
        <select id="fontName" class="adv-option-button form-control" style="width:auto;"></select>
        <select id="fontSize" class="adv-option-button form-control" style="width:auto;"></select>
      ...
      <div id="text-input" contenteditable="true"></div>
                ...
                //  var_dump($over_all_comment != "");
                 if($over_all_comment != ""){?>
                        <pre><textarea style="width:500px; margin: 10px; border-radius: 10px;" name="overall_data" placeholder="overall" rows="4" cols="50" id="overall_all_com"><?php echo $over_all_comment?></textarea></pre><br>
                        <?php }else{ ?>
                          <pre><textarea style="width:500px; margin: 10px; border-radius:10px;" name="overall_data" placeholder="overall" rows="4" cols="50" id="overall_all_com"> </textarea></pre><br>

                          <?php } ?>
                          <?php if($role=="instructor"){ ?>
                        <button type="button" data-bs-toggle="modal" id="additional_training" data-bs-target="#additional-training" class="btn btn-outline-success">Additional Task</button>
                        <button type="button" data-bs-toggle="modal" id="Unaccomplish_but" data-bs-target="#unaccomplish-training" class="btn btn-outline-success">Unaccomplish Task</button>
                   <?php } ?>
                    </center>
                  </div>
...
//  echo $fetch_overall_grade = $overall_grade->fetchColumn();
...
?>
          ...
          $grade=$row6['grade'];
          // echo $grade;
          // var_dump($row6['permission'] =='1');
        ?>
                     <input style="margin:10px;" onclick="return false" type="radio" class="myRadio" value="<?php echo $grade?>" <?php if($fetch_overall_grade==$grade) {echo "checked";}?> id="<?php echo $grade?>" name="overall_grade"><span style="font-weight:bold;" id="<?php echo $grade.'1';?>"><?php echo $grade?></span>
                         <?PHP }
                          ?>
                           <input type="radio" onclick="return false" class="myRadio" value="<?php echo $grade?>" <?php if($fetch_overall_grade==$grade) {echo "checked";}?> id="<?php echo $grade?>" name="overall_grade"><span hidden style="font-weight:bold;" id="<?php echo $grade.'1';?>"><?php echo $grade?></span>
                          <?php
                         }
                  ...
                  <tr>
                    ...
                    <?php if($fetch_overall_grade!=""){?>
                      <input type="hidden" required name="overall_grade_per" id="silder_get_value">
                      <input type="number" name="overall_grade_per" required style="color:white; text-align: center; font-weight:bold; font-size: large;<?php echo $bac_ground2?>" value="<?php echo $over_all_grade_per; ?>" class="form-control check_over_all_per" id="gradesper1" onkeyup="displayRadioValue(this.value);"/>
                      <?php }else{?>
                        <input type="number" name="overall_grade_per" required style="color:white; text-align: center; font-weight:bold; font-size: large;" class="form-control check_over_all_per" id="gradesper" onkeyup="displayRadioValue(this.value);">
                        <?php }?>
                   ...
                   <tr>
                    ...
                    <?php if($role=="instructor"){?>
                    <tr>
                      <td><center><input type="submit" id="submit_gradsheet_but" class="btn btn-success" name="ins_sub" onclick="return confirm('Are you sure?Once submitted gradsheet will get lock..?')" /></center></td>
                    </tr>
                      <?php } ?>
                </table>
              </center>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <center>
            ...
            <table class="table table-bordered src-table2" id="accomplishtable">
              <input class="form-control" type="text" id="accomplishsearch" onkeyup="accomplish()" placeholder="Search for Items" title="Type in a name"><br>
              <thead class="bg-dark">
                <tr>
            ...
            FROM item
            INNER JOIN  item_clone_gradesheet ON  item_clone_gradesheet.item_id = item.id where item.course_id='$std_course1' AND item.class_id='$classid' AND item.phase_id='$phase_id' AND item.class='$class_name' and  item_clone_gradesheet.user_id='$fetchuser_id' and  item_clone_gradesheet.grade='' and item_clone_gradesheet.cloned_id='$get_clone_ides'";       
           ...
           <?php 
             ...
             FROM subitem INNER JOIN subitem_cloned_gradesheet ON subitem_cloned_gradesheet.subitem_id = subitem.id where subitem.course_id='$std_course1' AND subitem.class_id='$classid' AND subitem.phase_id='$phase_id' AND subitem.class='$class_name' and subitem_cloned_gradesheet.user_id='$fetchuser_id' and subitem_cloned_gradesheet.grade='' and subitem_cloned_gradesheet.cloned_id='$get_clone_ides'";       
                ...
                <table class="table table-bordered">
                    <thead class="bg-dark">
                      <tr>
                        ...
                        <th scope="col" class="text-light">Percentage</th>
...
<div class="modal fade" id="additional-training" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
           <table class="table table-bordered src-table1" id="additionaltable">
            <input class="form-control" type="text" id="additionalsearch" onkeyup="additional()" placeholder="Search for Item.." title="Type in a name"><br>
              <thead class="bg-dark">
                <tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="modal-body">
                <form method="GET" action="grade_notification.php">
...
$(document).on("click","#unlock_gradsheet",function()
    ...
    if(check_admin_password == ""){
      ...
      $.ajax({
        ...
        data:'gradesheetid='+gradesheetid+'&check_admin_username='+check_admin_username+'&check_admin_password='+check_admin_password+'&clone_id='+get_clone_ides_val,
...
<script>
$(document).on("keyup","#gradesper1",function()
  {
    var val = $(this).val();
    if(val>=101){
      ...
      $.ajax({
        ...
        success:function(response){
          if(response == "U"){
            ...
            document.querySelector("#gradesper1").style.backgroundColor = '#ed4c78';
            document.querySelector("#gradesper1").style.fontSize = 'larger';
            document.querySelector("#gradesper1").style.fontWeight = 'bolder'; 
          }
          if(response == "F"){
            ...
            document.querySelector("#gradesper1").style.backgroundColor = '#f5ca99';
            document.querySelector("#gradesper1").style.fontSize = 'larger';
            document.querySelector("#gradesper1").style.fontWeight = 'bolder';
          }
          if(response == "G"){
        ...
        document.querySelector("#gradesper1").style.backgroundColor = '#71869d';
        document.querySelector("#gradesper1").style.fontSize = 'larger';
        document.querySelector("#gradesper1").style.fontWeight = 'bolder';
          }
          if(response == "V"){
        ...
        document.querySelector("#gradesper1").style.backgroundColor = '#00c9a7';
        document.querySelector("#gradesper1").style.fontSize = 'larger';
        document.querySelector("#gradesper1").style.fontWeight = 'bolder';
          }
          if(response == "E"){
        ...
        document.querySelector("#gradesper1").style.backgroundColor = '#377dff';
        document.querySelector("#gradesper1").style.fontSize = 'larger';
        document.querySelector("#gradesper1").style.fontWeight = 'bolder';
          }
          if(response == "N"){
...
function accomplish() {
  ...
  filter = input.value.toUpperCase();
  table = document.getElementById("accomplishtable");
  tr = table.getElementsByTagName("tr");
  for (i = 0; i < tr.length; i++) {
...
function additional() {
  ...
  filter = input.value.toUpperCase();
  table = document.getElementById("additionaltable");
  tr = table.getElementsByTagName("tr");
  for (i = 0; i < tr.length; i++) {
    td = tr[i].getElementsByTagName("td")[1];
    if (td) {
