                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4">
                     <div class="form-outline">
                      <label class="form-label" for="item_name" style="color: black; font-weight:bold;">Task Name<span><i class="bi bi-asterisk text-danger m-2" style="font-size: x-small;"></i></span></label>
                  ...
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <label class="form-label" for="date" style="color: black; font-weight:bold;">Due Date<span><i class="bi bi-asterisk text-danger m-2" style="font-size: x-small;"></i></span></label>
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <label class="form-label" for="coursemanager" style="color: black; font-weight:bold;">Assigned From<span><i class="bi bi-asterisk text-danger m-2" style="font-size: x-small;"></i></span></label>
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <label class="form-label" for="status" style="color: black; font-weight:bold;">Attachments<span><i class="bi bi-asterisk text-danger m-2" style="font-size: x-small;"></i></span></label>
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline">
                      <label class="form-label" for="coursemanager" style="color: black; font-weight:bold;">Progress<span><i class="bi bi-asterisk text-danger m-2" style="font-size: x-small;"></i></span></label>
