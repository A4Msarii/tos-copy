...
if(move_uploaded_file($_FILES["image"]["tmp_name"], $targetFilePath)){
  	$subquery1 = "INSERT INTO  logo_cert (cert_id,image_height,image_width,border_radius,border,border_color,file_name) VALUES ('$cert_id','$image_height','$image_width','$border_radius','$border','$border_color','$fileName')";
