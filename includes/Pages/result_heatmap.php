          ...
          <div class="card card-hover-shadow h-100" style="border:0.001rem solid #dddddd;">
            ...
            <div class="col-sm-auto" style="text-align: center; margin: 10px;">
                    ...
                    <ul class="nav nav-pills justify-content-center mb-7" role="tablist">
                      ...
                      <li class="nav-item bg-soft-success" style="border-radius: 20px;">
            ...
            <div class="card-body">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="Metrix1" role="tabpanel" aria-labelledby="Metrix1-tab">
                  <?php 
                  if($fetchuser_id!=0){
                  include ROOT_PATH . 'includes/Pages/dashboard/heatmap.php';
                  }else if($fetchuser_id==0){
                  include ROOT_PATH . 'includes/Pages/dashboard/allheatmap.php'; 
                  }
                  ?>
                </div>
