     ...
     <div>
      <div class="content container-fluid" style="height: 30rem;">
        ...
        <div class="page-header" style="padding: 0px;">
          <h1 class="text-success">Manage Phase On Acedemic Page</h1>
        </div>
        <!-- End Page Header -->
      </div>
    </div>
...
if (isset($_SESSION['ctp_value'])) {?>
            ...
            <div class="card-body">
                ...
                <form action="selected_phase_acedemic.php" method="post" style="width:100%;" enctype="multipart/form-data">
...
if ($select_ctps2->rowCount() > 0) {
    ...
    foreach ($select_ctpsre2 as $select_ctpsrow2) {
        ...
        $sql = "SELECT count(*) FROM `acedemic_phase` WHERE phase = ?";
...
<hr>
              <br><br>         <table class="table table-striped table-bordered">
                    ...
                    <?php
$query112 = "SELECT * FROM acedemic_phase where ctp_id='$ctp'";
    ...
    foreach ($result112 as $row112) {
        ...
        ?>
                      <tr>
                       ...
                       <td>
                       <a href="acedemic_phase_del.php?id=<?php echo $del_id_phase ?>"><i class="bi bi-trash-fill text-danger"></i></a>
