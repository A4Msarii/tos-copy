  ...
  <meta charset="utf-8" />
    <meta name="viewport" 
          content="width=device-width, 
                   initial-scale=1" />
                   <link rel="shortcut icon" href="<?php echo BASE_URL; ?>assets/svg/2D icons PNG/new/MicrosoftTeams-image (21).png">
</head>
<body>
          ...
          <div class="card card-hover-shadow h-100">
            ...
            <div class="card-body">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="mb-4">
                    <div class="page-header page-header-light">
                      <img src="<?php echo BASE_URL;?>assets/svg/2D icons PNG/new/MicrosoftTeams-image (21).png" style="height:40px; width: 40px; margin: 5px;">
                      <span style="color:black; font-weight:bold;">HOTWASH</span>
                    </div>
