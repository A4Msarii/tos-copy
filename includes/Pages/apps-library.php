...
<head>
    ...
    <meta name="viewport" 
          content="width=device-width, 
                   initial-scale=1" />
                   <link rel="shortcut icon" href="<?php echo BASE_URL; ?>assets/svg/thumbnail/lib.png">
</head>
<body>
     ...
     <div>
      <div class="content container-fluid" style="height: 25rem;">
       ...
       <!--  <div class="page-header page-header-light">
          <img style="height: 50px;" class="img-fluid" src="./assets/svg/logos/lib.svg" alt="SVG Illustration">
        </div> -->
        <!-- End Page Header -->
      </div>
    </div>
            ...
            <div class="card-body">
              	<div class="row justify-content-sm-between align-items-sm-center flex-grow-1">
			          ...
			          <div class="col-sm-6">
			            ...
			            <div class="mb-4">
			            	 <div class="page-header page-header-light">
          <img src="<?php echo BASE_URL;?>assets/svg/new/L logo.svg" style="height:40px; width: 40px; margin: 3px;">
          <span style="color:black; font-weight:bold;">Library</span>
        </div>
			              <!-- <h1 class="text-success">Library</h1> -->
