...
if ($btnType == "accomplish") {
    $sql_add = "INSERT INTO accomplish_task (Item_ac, gradsheet_id, Stud_ac, Type,clone_id) VALUES ('$data_id', '$gr_id', '$std_id', '$type','$cloneId')";
}

if ($btnType == "additional") {
    $sql_add = "INSERT INTO additional_task (Item, gradesheet_id, Stud_id, type,clone_id) VALUES ('$data_id', '$gr_id', '$std_id', '$type','$cloneId')";
}
