...
<head>
    ...
    <meta name="viewport" 
          content="width=device-width, 
                   initial-scale=1" />
                   <link rel="shortcut icon" href="<?php echo BASE_URL; ?>assets/svg/thumbnail/sche.png">
</head>
<body>
            ...
            <div class="card-body">
              	<div class="row justify-content-sm-between align-items-sm-center flex-grow-1">
			          ...
			          <div class="col-sm-6">
			            ...
			            <div class="mb-4">
			            	<div class="page-header page-header-light">
						          <img src="<?php echo BASE_URL;?>assets/svg/new/S logo.svg" style="height:40px; width: 40px; margin: 3px;">
						          <span style="color:black; font-weight:bold;">Schedulling</span>
						        </div>
			              <!-- <h1 class="text-success">Scheduling</h1> -->
