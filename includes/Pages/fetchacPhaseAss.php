         ...
         if (isset($roled['assingeresource']) && $roled['assingeresource'] == 1) {
            ...
            if ($st2->rowCount() > 0) {
                ...
                foreach ($re2 as $row2) {
                    ...
                    $checkUser = $connect->query("SELECT count(*) FROM academicassignee WHERE filesId = '$fileId' AND instId = '$uId' AND phaseId = '$phaseId' and coursecode='$coursecode' and coursename='$coursename'");
